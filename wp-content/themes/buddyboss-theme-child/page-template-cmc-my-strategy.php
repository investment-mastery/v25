<?php
/*
 * Template name: CMC My Strategy Template
 *
 */
    ...
    <div class="col-lg-12 col-sm-12"> 
      <div class="tab_mobile_scroll">      
        <div class="entry-header tab">
            ...
            <!-- <a class="tablinks" href="/cm-calculator">Strategy</a> -->
            <a class="tablinks active" onclick="openContent(event, 'my-strategy')">My Strategies</a>
            <a class="tablinks" href="/cmc-my-alerts">My Alerts <span id="alert_notify_cnt"></span></a>
        </div>
      </div>  
    </div>
        ...
        <div id="my-strategy" class="container tab-pane" style="padding:0">
            <div class="col-lg-12 col-sm-12">
                <div class="search-filters">
                    ...
                    <div class="col-lg-2 col-sm-12 my-stra-text2">
                        <i class="fa fa-money mr-1 stock-icon"></i> <select name="strategy_for_search" class="form-select form-select-lg form-control" id="strategy_for_search" placeholder-text="Strategy for">
                            <option value=""></option>
...
<div class="popup"  style="max-width:1150px !important;">
    ...
    <div class="content">
        ...
        <div id="outer_tab_content">
            ...
            <div class="calculate" id="calculator_div">
                <div class="edit_header_row">
                    <div class="edit_header_row_1 row_left">
            ...
            <div id="strategy_profit_tab_content">
                ...
                <div class="profit-strategy-table">
                    <table class="table table-striped text-center" id="edit_profit_table" style="background-color:#efefef;">
                        ...
                        <input type="hidden" name="profit_cm_type" id="profit_cm_type">
                        <input type="hidden" name="profit_strategy_type" id="profit_strategy_type">
                    </table>
                </div>
...
function getRecapData(entryLvl, strategyid, strategyname, stockname, currency, weekhigh, investment_total, stockprice, cm_strategy_for) {
    ...
    $.each(entery_level_arr, function (index, value) {
        ...
        //var entery_price = parseFloat(stockprice-entery_price_val).toFixed(6);   
 console.log("entery_price ===== RECAP === "+entery_price);                  
 ...
 console.log("tot_no_of_share_buy ===== RECAP === "+tot_no_of_share_buy); 
        /*if(entery_price <= updated_investment) {*/
            if(tot_no_of_share_buy ==0) {
                ...
                no_of_share_buy = (buy_share_string).toFixed(6);
                tot_no_of_share_buy = +(tot_no_of_share_buy) + +(no_of_share_buy);
            }
...
$(document).ready(function () {
    ...
    function fetch_strategy_data(calc_type = 'CMC', start_date = '', end_date = '', stock_name ='', currency = '', strategy_for = '', search_keyword = '') {
    ...
    $("#strategy_profit_tab_content").on("blur", "#profit_header_strategy_name_input", function() {
        ...
        console.log("new Strategie Name = "+new_strategy_name+" :: for strategy id = "+strategy_id);
    ...
    $("#strategy_edit_tab_content").on("click", "#edit_header_investment", function() {
        ...
        if(chkEntries == 1) {
            $("#edit_header_investment_p").empty().html('Trade Amount: <input type="number" class="form-control invested_val input_num_validate" name="edit_header_investment_input" id="edit_header_investment_input" value="'+old_investment+'" style="width: 95px !important; height: 25px !important;" >');
        }
    ...
    $("#strategy_edit_tab_content").on("blur", "#edit_header_investment_input", function() {
        ...
        $("#edit_header_investment_p").empty().html('Trade Amount <button class="edit_blue_box" id="edit_header_investment">'+new_investment+'</button>');  
    ...
    $("#strategy_profit_tab_content").on("click", "#profit_header_investment", function() {
        ...
        if(chkEntries == 1) {
            $("#profit_header_investment_p").empty().html('Trade Amount: <input type="number" class="form-control invested_val input_num_validate" name="profit_header_investment_input" id="profit_header_investment_input" value="'+old_investment+'" style="width: 95px !important; height: 25px !important;" >');
        }
    ...
    $("#strategy_profit_tab_content").on("blur", "#profit_header_investment_input", function() {
        ...
        $("#profit_header_investment_p").empty().html('Trade Amount <button class="edit_blue_box" id="profit_header_investment">'+new_investment+'</button>');  
...
console.log("your_investment === "+your_investment);
    ...
    /*Update Stratergy : END */
     ...
     $('#sevieces_tbl_date').daterangepicker(
          ...
          function (start, end) {       
            ...
            fetch_strategy_data('CMC', start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'), $( "#stock_filter" ).val(), $("#currency_search").val(), $("#strategy_for_search").val(), $('#txtSearch').val());
          }
        ); 
    ...
    $( "#stock_filter" ).on('autocompleteselect', function (e, ui) {
        ...
        fetch_strategy_data('CMC', filter_start_date, filter_end_date, myArray[0], $("#currency_search").val(), $("#strategy_for_search").val(), $('#txtSearch').val());        
    });
    ...
    $('body').on('keydown', '#txtSearch', function(e) {
        if (e.which == 9 || e.which == 13) {
            ...
            fetch_strategy_data('CMC', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $("#currency_search").val(), $("#strategy_for_search").val(), $('#txtSearch').val());  
        }
    });

    $(document.body).on("click",".select-dropdown__list--0 .select-dropdown__list-item",function() {
        fetch_strategy_data('CMC', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $(this).data("value"), $("#strategy_for_search").val(), $('#txtSearch').val()); 
    });

    $(document.body).on("click",".select-dropdown__list--1 .select-dropdown__list-item",function() {
        fetch_strategy_data('CMC', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $("#currency_search").val(), $(this).data("value"), $('#txtSearch').val()); 
    });
        ...
        $("#edit-Strategy-table-body .purchase_date").each(function (index, value) {   
            ...
            if($("#edit_stock_buy_date"+cnt_val).val() != '' && $("#edit_invested_cost_"+cnt_val).val() > 0 && $("#edit_entry_cost_"+cnt_val).val() > 0 ) {
                ...
                if(cm_strategy_for == "SELL") {
                    ...
                    shares_to_buy = parseFloat($("#edit_invested_cost_"+cnt_val).val() / $("#edit_entry_cost_"+cnt_val).val()).toFixed(6);
                }
                ...
                if(shares_to_buy < 1) {
                    $("#edit_no_share_val_"+cnt_val).empty().html(parseFloat(shares_to_buy).toFixed(6));
                    $("#edit_tot_no_share_val_"+cnt_val).empty().html(parseFloat(total_share_buy).toFixed(6));
                } else {
                    $("#edit_no_share_val_"+cnt_val).empty().html(parseFloat(shares_to_buy).toFixed(2));
                    $("#edit_tot_no_share_val_"+cnt_val).empty().html(parseFloat(total_share_buy).toFixed(2));
                }
...
function openPopupContent(evt, contentName) {
    ...
    /*poonam added 19apr*/
    if(contentName == 'strategy_edit_tab_content'){
        $(".view-strategy-table").hide();
        $("#calculator_div").hide();
    }else if(contentName == 'strategy_profit_tab_content'){
        $(".view-strategy-table").hide();
        $("#calculator_div").hide();
    }else if(contentName == 'graph_tab_content'){
        $(".view-strategy-table").hide();
        $("#calculator_div").hide();
    }else{
        $(".view-strategy-table").show();
        $("#calculator_div").show();
    }
    ...
    function getStrategyProfitData(data) {
        ...
        for (var i = 0; i < data['profits'].length; i++) {
            ...
            /*RAM MODIFIED ON 17NOV23*/  
              var chkBox = '';
            if(total_tokens >= 0)  //poonam modifed 14may
            {
...
console.log("total_investment ::: "+data['strategy'][0]['your_investment']); */ 
        ...
        $("#profit_header_average_price").empty().html(parseFloat(data['strategy'][0]['average_share_price']).toFixed(2)); //poonam modifed 14may
        $("#profit_header_price_diff").empty().html(parseFloat(data['strategy'][0]['share_price_difference']).toFixed(2));
