...
/*CSS ADDED BY RAM TO FIX TITLE AND HEADER ISSUE ON 12DEC23*/
@media (min-width: 768px){
.elementor-1070 .elementor-element.elementor-element-468bc0b8 {
    width: 10%;
}
}
    ...
    <div class="bb-grid grid">
        ...
        <div id="learndash-page-content">
            <div class="learndash-content-body">
                ...
                <?php echo do_shortcode( '[elementor-template id="19804"]' ); ?>
                <!--ADDED SHORTCODE HERE TO SHOW QUIZ TITLE-->
                        </div>
                        <?php
                        global $post;
