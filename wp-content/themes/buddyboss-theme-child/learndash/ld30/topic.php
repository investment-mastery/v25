                ...
                if ( ! empty( $buddyboss_content ) ) {
                    ...
                    <div class="learndash_content_wrap">
                        ...
                        <?php
                            ...
                            /* start topic audio */
                            $topic_audio = get_field("topic_audio");
                            if(!empty($topic_audio)){
                                ?>
                                <audio style="width:100%" controls>
                                    <source src="<?=$topic_audio?>" type="audio/mpeg">
                                </audio>
                                ...
                                <a 
                                    style="width: 100%;
                                            ...
                                            height: 56px;
                                            background: #3da0dd;
                                            -webkit-box-shadow: inset 0px -4px 0px rgb(0 0 0 / 10%);
                                            box-shadow: inset 0px -4px 0px rgb(0 0 0 / 10%);
                                            border-radius: 8px;
                                            ...
                                            display: block;
                                            text-align: center;"
                                    href="<?=$topic_audio?>" download>Download Audio</a>
                                <?php
                            }
...
<script>
    jQuery(document).ready(function ($) {
        function addPadding (){
            let height = $('.ld-content-actions').outerHeight();
            $('.learndash_content_wrap').css('padding-bottom', height);
        }
