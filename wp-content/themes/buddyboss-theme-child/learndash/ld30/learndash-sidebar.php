...
<div class="lms-topic-sidebar-wrapper <?php echo $side_panel_state_class;?>">
	<div class="lms-topic-sidebar-data">
        ...
        <span class="sidebar-mini-button show_sidebar_content active_sidebar_button"></span>
        <span class="sidebar-mini-button show_sidebar_note"></span>
            ...
            <div class="course-details">
                <div class="lms-topic-sidebar-course-navigation">
                    <div class="ld-course-navigation">
                        ...
                        <?php 
                        if(!empty($_GET["from_path"])){
                            $link = site_url("/");
                            $text = "Back to path";
                        }else{
                            $link = get_permalink( $parent_course->ID );
                            $text = "Back to course";
                        }
                        ?>
                        <a title="<?php echo $parent_course_title; ?>" href="<?php echo $link; ?>" class="course-entry-link">
                            <span>
                                <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.429 7H1m0 0l6 6M1 7l6-6" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <?=$text?>
                        ...
                        <h2 class="course-entry-title">
                            <?php if ($icon = get_field('icon', $course_id)): ?>
                                <img src="<?=$icon?>" alt="Course Icon">
                            <?php endif; ?>
                            <span><?php echo $parent_course_title; ?></span>
                        </h2>
                    </div>
                </div>

                <div class="lms-topic-sidebar-progress">   
                    <h4 class="course-content-text">Course Content</h4>
    		...
    		<div class="lms-lessons-list">
    			...
    			?>
    				...
    				<ol class="bb-lessons-list">
    					<?php foreach( $lession_list as $key => $lesson ) { ?>
    						...
    						<li class="lms-lesson-item <?php echo $lesson->ID == $post->ID ? 'current' : 'lms-lesson-turnover'; ?> <?php echo $lesson_sample . ' ' . $locked_class; ?> <?php echo !empty( $lesson_topics ) ? '' : 'bb-lesson-item-no-topics'; ?>">
                                ...
                                <?php if( ! empty( $lesson_topics ) ) : ?>
                                    <span class="lms-toggle-lesson"><svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.071.505L.15 8.46C-.268 9.134.237 10 1.08 10h9.843c.84 0 1.347-.865.928-1.541L6.928.505a1.038 1.038 0 00-.391-.37 1.124 1.124 0 00-1.074 0 1.038 1.038 0 00-.392.37z" fill="#fff"/></svg></span>
                                <?php endif; ?>
    							<a href="<?php echo get_permalink( $lesson->ID ); ?>" title="<?php echo $lesson->post_title; ?>" class="bb-lesson-head flex">
                                    ...
                                    <div class="progress-circle flex align-items-center <?php echo $lesson_progress['percentage'] == '100' ? 'bb-check-completed' : 'bb-check-not-completed'; ?>">
                                        <div class="bb-lms-progress-wrap" data-balloon-pos="right" data-balloon="<?php echo $lesson_progress_data_balloon; ?>">
                                            <?php if ($lesson_progress['percentage'] == '100') { ?>
                                                <div class="i-progress i-progress-completed i-progress-custom-ls">                                               
                                                    <?php if($locked_class == 'lms-is-locked') { ?>  
                                                        <img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_lock.png">
                                                    <?php } else { ?>    
                                                        <img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_check.png">
                                                    <?php } ?>
                                                </div>
                                           
                                            <?php } elseif ($lesson_progress['percentage'] == '0') { ?>
                                                <div class="i-progress <?php echo $completed ? 'bb-completed' : 'bb-not-completed'; ?> i-progress-custom-ls" data-percentage="<?php echo $lesson_progress['percentage']; ?>">
                                                    <?php if($locked_class == 'lms-is-locked') { ?>  
                                                         <img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_lock.png">
                                                    <?php } else { ?>    
                                                        <img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_play.png" class="ls_play_icon">
                                                    <?php } ?>
                                                </div>                  

                                            <?php } else { ?>
                                                <div class="i-progress <?php echo $completed ? 'bb-completed' : 'bb-not-completed'; ?> lesson-in-progress i-progress-custom-ls" data-percentage="<?php echo $lesson_progress['percentage']; ?>">
                                                    <?php if($locked_class == 'lms-is-locked') { ?>  
                                                         <img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_lock.png">
                                                    <?php } else { ?>    
                                                        <img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_play.png" class="ls_play_icon">
                                                        ...
                                                        <a class="flex bb-title bb-lms-title-wrap"
                                                           ...
                                                           title="<?php echo $lesson_topic->post_title; ?>">
    														...
    														if ( ! empty( $lesson_video_enabled ) ) { ?>
                                                                <span class="bb-lms-ico bb-lms-ico-topic"><svg width="23" height="16" viewBox="0 0 23 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22.5 3l-7 5 7 5V3zM13.5 1h-11a2 2 0 00-2 2v10a2 2 0 002 2h11a2 2 0 002-2V3a2 2 0 00-2-2z" stroke="#A7AFB9" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
    														<?php } else { ?>
                                                                <span class="bb-lms-ico bb-lms-ico-topic"><svg width="17" height="22" viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.5 1h-8a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7m-6-6l6 6m-6-6v6h6m-4 5h-8m8 4h-8m2-8h-2" stroke="#A7AFB9" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
    														<?php } ?>
    														...
    														<?php if ( ( ! empty( $course_progress[ $course_id ]['topics'][ $lesson->ID ][ $lesson_topic->ID ] ) && 1 === $course_progress[ $course_id ]['topics'][ $lesson->ID ][ $lesson_topic->ID ] ) ) : ?>
                                                                <div class="bb-completed bb-lms-status"
                                                                    ...
                                                                    <div class="i-progress i-progress-completed i-progress-custom-ls"><i
                                                                                class="bb-icon-check bb-icon-check-custom-ls"></i></div>
                                                                </div>
    														<?php else : ?>
                                                                <div class="bb-not-completed bb-lms-status"
                                                                     data-balloon-pos="left"
                                                                     data-balloon="<?php _e( 'Not Completed', 'buddyboss-theme' ); ?>">
                                                                    <div class="i-progress i-progress-not-completed i-progress-custom-ls"><i
                                                            ...
                                                            <ol class="lms-quiz-list">
    															<?php foreach ( $topic_quizzes as $topic_quiz ) {
    																...
    																if ( $has_access ) {
                                                                        ...
                                                                        <span class="bb-lms-ico bb-lms-ico-quiz"><svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.59 8a3 3 0 015.83 1c0 2-3 3-3 3m.08 4h.01m9.99-5c0 5.523-4.477 10-10 10S.5 16.523.5 11s4.477-10 10-10 10 4.477 10 10z" stroke="#A7AFB9" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
    																			...
    																			<?php else: ?>
                                                                                    <div class="bb-not-completed bb-lms-status"
                                                                                         data-balloon-pos="left"
                                                                                         data-balloon="<?php _e( 'Not Completed', 'buddyboss-theme' ); ?>">
                                                                                        <div class="i-progress i-progress-not-completed i-progress-custom-ls">
    											...
    											<a class="flex bb-title bb-lms-title-wrap" href="<?php echo get_permalink( $lesson_quiz['post']->ID ); ?>" title="<?php echo $lesson_quiz['post']->post_title; ?>">
                                                    ...
                                                    <?php if ( learndash_is_quiz_complete($user_id,$lesson_quiz['post']->ID) ) : ?>
                                                        <div class="bb-completed bb-lms-status" data-balloon-pos="left" data-balloon="<?php _e( 'Completed', 'buddyboss-theme' ); ?>">
                                                            <div class="i-progress i-progress-completed i-progress-custom-ls"><img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_check.png"></div>
                                                        </div>
    												<?php else: ?>
    													<div class="bb-not-completed bb-lms-status" data-balloon-pos="left" data-balloon="<?php _e( 'Not Completed', 'buddyboss-theme' ); ?>">
                                                            <div class="i-progress i-progress-not-completed i-progress-custom-ls"><i class="bb-icon-circle"></i></div>
                                                        </div>
    												<?php endif; ?>
    											</a>
    										</li>
    			...
    			<div class="lms-course-quizzes-list">
    				...
    				<ul class="lms-quiz-list bb-type-list">
    					<?php foreach( $course_quizzes as $course_quiz ) {
                            ...
                            $atts = apply_filters( 'learndash_quiz_row_atts', ( isset($has_access) && !$has_access && !$is_sample ? 'data-balloon-pos="up" data-balloon="' . __( "You don't currently have access to this content", "buddyboss-theme" ) . '"' : '' ) );
                            $atts_access_marker = apply_filters( 'learndash_quiz_row_atts', ( isset($has_access) && !$has_access && !$is_sample ? '<span class="lms-is-locked-ico"><img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ls_lock.png"></span>' : '' ) );
                            $locked_class = apply_filters( 'learndash_quiz_row_atts', ( isset($has_access) && !$has_access && !$is_sample ? 'lms-is-locked' : 'lms-not-locked' ) );
                           ?>
        ...
        <div class="sidebar-content-2">
            ...
            <form id="frm_save_note">
                <textarea name="sidebar_note" class="sidebar_note" id="sidebar_note_text" placeholder="Enter your notes here"><?php echo get_user_meta($user_id, "lesson_notes_".get_the_ID(), true);  ?></textarea>
                <button class="btn_save_note">Save Notes</button>
            </form>
