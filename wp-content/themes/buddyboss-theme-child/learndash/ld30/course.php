...
<style>
    .learndash-wrapper div.ld-item-list, .ld-item-list-items{ margin-top: 0; }
    .bb-ld-tabs { display: block !important; }
    .ld-tab .ld-text{ font-size:1.3em }
    .learndash-wrapper .ld-tabs .ld-tabs-navigation .ld-tab, 
    .learndash-wrapper .ld-tabs .ld-tabs-navigation .ld-tab.ld-active, 
    .learndash-wrapper .ld-tabs .ld-tabs-navigation .ld-tab:hover { border-radius: 0; }
</style>
    ...
    <div id="learndash-course-content"></div>
        <div class="ld-tabs ld-tab-count-2">
            <div role="tablist" class="ld-tabs-navigation">
                ...
                <button role="tab" aria-controls="content-tab" id="ld-content-tab-<?php echo get_the_ID();?>" class="ld-tab ld-active" data-ld-tab="ld-tab-content-<?php echo get_the_ID();?>" aria-selected="true">
                    <span class="ld-text">Course</span>
            </button>
                    
                <button role="tab" aria-controls="materials-tab" id="ld-materials-tab-<?php echo get_the_ID();?>" class="ld-tab" data-ld-tab="ld-tab-materials-<?php echo get_the_ID();?>">
            ...
            <div class="ld-tabs-content">
                    ...
                    <div role="tabpanel" tabindex="0" aria-labelledby="content" class="ld-tab-content ld-visible" id="ld-tab-content-<?php echo get_the_ID();?>">
            ...
            ?>                                        
                    ...
                    <div role="tabpanel" tabindex="0" aria-labelledby="materials" class="ld-tab-content" id="ld-tab-materials-<?php echo get_the_ID();?>">
                        <?php echo $materials;?>
                    </div>
