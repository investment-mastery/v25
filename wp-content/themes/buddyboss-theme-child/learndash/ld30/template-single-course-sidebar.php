            ...
            <div class="bb-course-preview-content">
                ...
                <div class="bb-button-wrap">
					...
					if ( empty( $course_progress ) && $course_progress < 100 ) {
						...
						$btn_advance_label = __( '<svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21.5 11.08V12a10 10 0 11-5.93-9.14M21.5 4l-10 10.01-3-3" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Completed', 'buddyboss-theme' );
					} else {
					...
					if ( $course_price_type == 'open' || $course_price_type == 'free' ) {
						...
						if ( $course_price_type == 'open' ) {
							?>
                            <span class="bb-course-type bb-course-type-open test"><?php _e( 'Open Registration', 'buddyboss-theme' ); ?></span><?php
						} else {
							?>
				...
				if ( sizeof( $lesson_count ) > 0 || $topics_count > 0 || $course_quizzes_count > 0 || $course_certificate ) { ?>
                    ...
                    <ul class="bb-course-volume-list">
						...
						<?php if ( $course_quizzes_count > 0 ) { ?>
                            <li>
                                <i class="bb-icons bb-icon-check-circle"></i><?php echo $course_quizzes_count; ?> <?php echo $course_quizzes_count != 1 ? LearnDash_Custom_Label::get_label( 'quizzes' ) : LearnDash_Custom_Label::get_label( 'quiz' ); ?>
                            </li>
						<?php } ?>
