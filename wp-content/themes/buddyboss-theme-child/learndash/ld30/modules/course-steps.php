...
if( !empty($learndash_previous_nav) || !empty($learndash_next_nav) || !empty($complete_button) ): ?>
	...
	<div class="ld-content-actions">
		...
		<div class="ld-content-action<?php if (( ! $can_complete ) && ( ! $learndash_next_nav )) : ?> ld-empty<?php endif; ?>">
			...
			if (learndash_is_topic_complete( $user_id = $user_id, $topic_id = get_the_ID() )):
				?>
				<button class="btn-markcomplete"><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22.5 11.08V12a10 10 0 11-5.93-9.14M22.5 4l-10 10.01-3-3" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> <span>Marked As Complete</span></button>
				<?php
			endif;
			?>
