<?php
/*
 * Template name: YCC VCA My Strategy Template
 *
 */
    ...
    <div class="col-lg-12 col-sm-12"> 
      <div class="tab_mobile_scroll">
        <div class="entry-header tab">
            <a class="tablinks tab_first" href="/ycc-vca-calculator">VCA Calculator</a>
            <a class="tablinks" href="/ycc-vca-calculator">Strategy</a>
            <a class="tablinks active" onclick="openContent(event, 'my-strategy')">My Strategies</a>
            <a class="tablinks" href="/ycc-vca-my-alerts">My Alerts <span id="alert_notify_cnt"></span></a>
        </div>
      </div>
    </div>
                ...
                <div class="content_edit" id="strategy_edit_tab_content">
                    ...
                    <div style="clear: both;">
                        <div class="edit-link-div">
                           <a href="/ycc-vca-calculator"> <button type="button" class="btn-calculate"><i class="fa fa-calculator" aria-hidden="true"></i>VCA Calculator</button></a>
...
console.log("cnt_val :: "+cnt_val);*/            
            ...
            if($("#edit_stock_sale_date"+cnt_val).val() != '' && $("#edit_your_fiat_sale_sum_"+cnt_val).val() > 0 && $("#edit_your_take_profit_price_"+cnt_val).val() > 0) {
                ...
                if(cnt_val == 0) {
                    ...
                    current_holdings_prev = current_holdings;  
/*console.log("------------- IF all data present & Count = 0 -------------");
console.log("sale_sum :: "+sale_sum); 
...
$("#profit_header_current_holding_value").empty().html(currencySymbol[currency]+Math.abs(total_holding_value).toFixed(2));
