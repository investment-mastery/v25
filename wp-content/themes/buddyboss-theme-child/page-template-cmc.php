    ...
    <div class="row">
       <div class="tab_mobile_scroll">  
        <div class="entry-header tab">
            ...
            <!-- <a class="tablinks" onclick="openContent(event, 'cca-strategy')">Strategy</a> -->
            <a class="tablinks" onclick="saveStrategyAlert('/cmc-my-strategy')">My Strategies</a>
            <a class="tablinks" onclick="saveStrategyAlert('/cmc-my-alerts')">My Alerts <span id="alert_notify_cnt"></span></a>
        </div>
      </div>    
        <p class="x-error"></p>
    </div>
  <div class="watchnow">    <?php echo do_shortcode( '[elementor-template id="18155"]' ); ?></div>
    <!-- Tab panes -->

    <div class="d-flex mb-40">
        <div class="col-md-4">
            <b class="bactive" id="cmc_type_fiat">FIAT</b>
            <label class="switch">                                
                <input type="checkbox" name="cmc_type" id="cmc_type" value="crypto" />
                <span class="slider round"></span> 
            </label> 
            <b class="bactive ml-15" id="cmc_type_crypto">CRYPTO</b>
        </div>

        <div class="col-md-4">
            <b class="bactive" id="cmc_strategy_for_buy">BUY</b>
            <label class="switch">                                
                <input type="checkbox" name="cmc_strategy_for" id="cmc_strategy_for" value="sell" />
                <span class="slider round"></span> 
            </label> 
            <b class="bactive ml-15"  id="cmc_strategy_for_sell">SELL</b>
        </div>
    </div>
        ...
        <div id="home" class="tab-pane active"br>
            <div class="row" id="test">
                <div class="col-lg-4  col-sm-12">
                    <div class="percent1" id="stock_div">
                        <h4 style="">Base Currency</h4>
                        <input type="text" class="btn-primary percent1_input" name="stock" id="stock_ticker"  value="BTC" title="Enter Crypto" >
                    </div>

                    <div class="percent1" id="currency_div">
                        <h4 style="">Quote Currency</h4>
                    ...
                    <div class="percent1" id="quote_currency_div" style="display: none;">
                        <h4 style="">Quote Currency</h4>
                        <input type="text" class="btn-primary percent1_input" name="stock" id="quote_currency" value="BTC" title="Enter Crypto" >
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="blue-box">
                        ...
                        <h3><span id="stock_price"></span></h3>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="percent1" id="high_div">
                        <h4 style=""> Current RSI</h4>
                        <input type="number" class="btn-primary percent1_input input_num_validate" name="current_hight" id="current_hight"  value="40" title="Current RSI Value">
                    </div>

                    <div class="percent1" id="invest_div">
                        <h4 style="">Trade Amount</h4>
                ...
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="col-lg-4 col-sm-12">
                        <div id="div_sel_entry" class="calculate">
                            <div>
                                <select class="form-select form-select-lg form-control entry_dropdown" name="sel_entry_level" id="sel_entry_level" placeholder-text="3"  title="Select your total number of entries">
                                        <option value=""></option>
                        ...
                        <table class="table table-striped text-center">
                            <thead>
                                <tr class="vca_table_head">
                                    <th>Date</th>
                                    <th>Volume (<span id="volume_symbol">USD</span>)</th>
                                    <th>Your Entry Price (<span id="volume_symbol2">USD</span>)</th>
                                    <th>Value (<span id="value_symbol">BTC</span>)</th>                                    
                                    <th>Exchange fee %</th> 
                    ...
                    <div class="col-lg-6 col-sm-12" style="margin:20px 0;">
                        <div class="percent" style="padding:20px;">
                            ...
                            <div class="reult-stratergy">
                                <h2 style="color:#67c275;"> <span id="total_gain">0.00</span><i class="fa fa-arrow-up" aria-hidden="true"></i></h2>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    ...
                    <button type="button" onclick="printThisPage()" class="btn-dark">Print this page</button>
    ...
    <div class="row" style="display: none;" >
        <form method="Post" id="pdf_gen" action="/cmc-download-excel/" target="_blank">
            ...
            <input type="hidden" name="cm_type" id="cm_type_excel">
            <input type="hidden" name="cmc_strategy_for" id="cmc_strategy_for_excel">
            ...
            <input type="hidden" name="current_price" id="current_price_excel">
            ...
            <input type="hidden" name="avg_price_val" id="avg_price_val_excel">
...
var cm_type = 'FIAT';
var cm_strategy_for = 'BUY';

jQuery(document).ready(function ($) {

    var base_currency = $('#stock_ticker').val();
    

    $('#cmc_type_fiat').css('color','#122b46');
    $('#cmc_type_crypto').css('color','#a6b0ba');

    $('#cmc_strategy_for_buy').css('color','#122b46');
    $('#cmc_strategy_for_sell').css('color','#a6b0ba');

    $("#quote_currency_div").hide();
    
    $('#cmc_type').on('click', function () {
        
        if ($('#cmc_type').is(":checked")) {
console.log("CMC Type :: CRYPTO");
            cm_type = 'CRYPTO';
            $('#cmc_type_fiat').css('color','#a6b0ba');
            $('#cmc_type_crypto').css('color','#122b46');

            $("#stock_ticker").empty().val('ETH');
            base_currency = 'ETH';           

            $("#investment").val('0.4');
            $("#quote_currency_div").show();
            $("#currency_div").hide();
            $("#currency").val('BTC');

            getTickerDeatils($("#stock_ticker").val(), $("#quote_currency").val());

        } else {
console.log("CMC Type :: FIAT");
            cm_type = 'FIAT';
            $('#cmc_type_fiat').css('color','#122b46');
            $('#cmc_type_crypto').css('color','#a6b0ba');            
            ...
            getTickerDeatils($("#stock_ticker").val());
        }
    });


    $('#cmc_strategy_for').on('click', function () {
        
        if ($('#cmc_strategy_for').is(":checked")) {
            console.log("CMC Strategy for :: Sell");
            $('#cmc_strategy_for_buy').css('color','#a6b0ba');
            $('#cmc_strategy_for_sell').css('color','#122b46');
            $("#investment").val('0.4');
            cm_strategy_for = 'SELL';
            if(cm_type == 'FIAT') {
                var q_currency = $("#currency").val();
            } else {
                var q_currency = $("#quote_currency").val();
            }
console.log("Base currency for :: Sell - "+$("#stock_ticker").val());
console.log("Quote currency for :: Sell - "+q_currency);
            getTickerDeatils($("#stock_ticker").val(), q_currency);

        } else {
            console.log("CMC Strategy for :: Buy");
            $('#cmc_strategy_for_buy').css('color','#122b46');
            $('#cmc_strategy_for_sell').css('color','#a6b0ba');
    ...
    //let currencySymbol = {"USD":'&#36;', "GBP":'&pound;', "EUR":'&#8364;',"BTC":'₿', "AUD":'A&#36;'};
    ...
    function getTickerDeatils(val, val2='', tvw=true){

        if(val2 != '') {
            var quote_currency = val2;
        } else {
            var quote_currency = $("#currency").val();
        }
...
console.log("in response :: cm_strategy_for == "+cm_strategy_for);
                        if(cm_strategy_for == "SELL") {
                            $("#value_symbol").empty().text(quote_currency);
                            $("#volume_symbol").empty().text($("#stock_ticker").val());
                            $("#volume_symbol2").empty().text(quote_currency);
                        } else {
                            $("#value_symbol").empty().text($("#stock_ticker").val());
                            $("#volume_symbol").empty().text(quote_currency);
                            $("#volume_symbol2").empty().text(quote_currency);
                        }
    ...
    /* START - BASE CURRENCY AUTO SUGGEST */
...
console.log("CM TYPE == "+cm_type);
console.log("on autocompleteselect :: base_currency == "+stock);
        ...
        if(cm_type == 'CRYPTO') {   
            ...
            $.ajax({
                ...
                data : {
                    'base_currency' : stock,
                    'action'        : 'get_single_quote_currency',
                },
                dataType:'json',
                beforeSend : xhr => {
                    xhr.setRequestHeader('X-WP-Nonce', "<?=wp_create_nonce( 'wp_rest' );?>");
                ...
                success : function(data) { 
                    ...
                    $("#quote_currency").empty().val(data[0]['value']);
                    $("#currency").empty().val(data[0]['value']);

                    getTickerDeatils(stock, data[0]['value']);
                }
            });
console.log("on autocompleteselect :: quote_currency == "+$("#quote_currency").val());
    ...
    /* END - BASE CURRENCY AUTO SUGGEST */
    /* START - QUOTE CURRENCY AUTO SUGGEST */

    $("#quote_currency").autocomplete({
        /*source: '/wp-json/api/cca/?action=get_quote_currency&base_currency='+base_currency,*/
        source: function( request, response ) {
            $.ajax( {
                url: "/wp-json/api/cca/?action=get_quote_currency&base_currency="+base_currency,
                dataType: "json",
                data: {
                    term: request.term
                },
        ...
        response: function (event, ui) {
            if (ui.content.length === 0) {
                $('#currency_div').css('border', 'solid 1px red');
            } else {
                $('#currency_div').css('border', 'solid 1px #e1e1e1');
            }
        }
    }).focus(function() {
        $(this).autocomplete('search', $(this).val());        
    ...
    $("#quote_currency").keypress(function(e) {
        if(e.which == 13) {
            $('#quote_currency').trigger("focus");
        }
    });

    $('#quote_currency').on('autocompleteselect', function (e, ui) {
        //jQuery.parseJSON(
        var stock = ui.item.value;
        console.log(JSON.stringify(stock, null, 3));
        console.log("on autocompleteselect :: base_currency == "+base_currency);
        console.log("on autocompleteselect :: quote_currency == "+stock);
        $('#quote_currency').val(stock);       
        $("#currency").val(stock);
        getTickerDeatils(base_currency, stock);      

    });

    /* END - QUOTE CURRENCY AUTO SUGGEST */
    ...
    $(document).on("click", "#btn_save_strategy", e => {
        ...
        if(strategy_name == "") {
           $('#txtStrategyName').addClass("error");
            ...
            if(cm_strategy_for == "SELL") {
                var total_share_buy = $("#tot_invseted").text();
                var total_investment = $("#tot_amt_share").text();
            } else {
                var total_investment = $("#tot_invseted").text();
                var total_share_buy = $("#tot_amt_share").text();
            } 
            ...
            var temp_strategy = {
                ...
                "club_type": "YCC",
                "cmc_type": cm_type, 
                "strategy_type": cm_strategy_for, 
                "strategy_name": strategy_name, 
                "stock_name": stock_ticker, 
                "currency": q_currency, 
                "stock_price": ($("#stock_price").text()), 
                "52_week_high": $("#current_hight").val(), 
                "your_investment": your_investment, 
                "total_gain_loss": $("#total_gain").text(), 
                "total_gain_loss_percentage": $("#vca_result").text(), 
                "total_investment": total_investment, 
                "total_share_buy": total_share_buy, 
                "average_share_price": $("#avg_all_share_price").text(), 
                "share_price_difference": $("#diff_price").text()
            };
...
//console.log(JSON.stringify(temp_strategy, null, 3));
            $.ajax({
    ...
    $( "#calculate_btn" ).click(function() {
       ...
       /* var current_hight           = $("#current_hight").val();*/
        var current_hight           = $("#stock_price").text();
        var open                    = $("#open_prize").val();
        var high                    = $("#stock_price").val(); 
        ...
        if(stock !="" && currency !="" && investment !="" && current_hight !=""){
            ...
            $.each(entery_level_arr, function (index, value) {           
                ...
                prev_per_tot_amt = parseFloat(prev_per_tot_amt).toFixed(6);
                          
                var investment =   investment_tot * prev_per_tot_amt  / 100;
   
                investment = parseFloat(investment).toString().match(/^-?\d+(?:\.\d{0,6})?/)[0];
           
                tot_used_investment_per = tot_used_investment_per + parseFloat(prev_per_tot_amt);

                /* No of Share Buy start */
                if(cm_strategy_for == "SELL") {
                    var updated_investment  = parseFloat(investment);
                } else {
                    var updated_investment  = (parseFloat(investment) +  balance_amt).toFixed(6);
                }                
                ...
                {
                    if(cm_strategy_for == "SELL") {
                        no_of_share_buy = parseFloat(updated_investment).toFixed(6);
                        ...
                        no_of_share_buy = no_of_share_buy.toFixed(6);
                        tot_no_of_share_buy = parseFloat(tot_no_of_share_buy) + parseFloat(no_of_share_buy);
                        tot_no_of_share_buy = parseFloat(tot_no_of_share_buy.toFixed(5));
                    }                    
                }
                ...
                if(investment > 1) {
                    ...
                    investment = parseFloat(investment).toFixed(6);
                }

                table_values  +=' <tr><td>-'+value+'%</td><td>'+entery_price+'</td><td>'+investment+'</td><td>'+parseFloat(prev_per_tot_amt).toFixed(2)+'%</td><td>'+parseFloat(no_of_share_buy).toFixed(5)+'</td><td>'+tot_no_of_share_buy.toFixed(5)+'</td><td>'+parseFloat(avg_price_show2).toFixed(2)+'</td></tr>';
               
               if(cm_strategy_for == "SELL") {
                    str_invested_money = parseFloat(no_of_share_buy);
               } else {
                    str_invested_money = entery_price * parseFloat(no_of_share_buy);
               }

                if(str_invested_money > 1) {
                    str_invested_money = parseFloat(str_invested_money).toFixed(2);
                } else {
                    str_invested_money = parseFloat(str_invested_money).toFixed(6);
                }
            ...
            table_values +=' <tr><td  style=" border-color:none; border-width:0 !important;"></td><td class="total">Total</td><td class="total">'+Math.round(tot_used_investment)+'</td><td class="total">'+Math.round(inve_per)+'%</td><td class="total">'+tot_no_of_share_buy+'</td><td class="total">'+tot_no_of_share_buy+'</td></tr>';
            ...
            $("#total_gain").empty().html("0.00").css('color','#67c275');
             /*RAM ADDED IT ON 20NOV23*/
            $(".reult-stratergy i").attr('class', 'fa fa-arrow-up');
            $(".reult-stratergy i").css('color','#67c275');
             /*RAM ADDED IT ON 20NOV23*/
            $("#tot_invseted").empty().html("0.00");
            $("#tot_invseted_input").val("0.00");
            $("#tot_amt_share").empty().text("0.00");
            $("#avg_all_share_price").empty().html("0.00"); 
            $("#diff_price").empty().html("0.00");
 ...
 function downloadExcel(){
    ...
    $("#stratergy_table_values .purchase_date").each(function (index, value) {   
        ...
        if(stratergy_table_data_string == '') {
            stratergy_table_data_string += $("#invested_cost_"+cnt_val).val() + "|" + $("#entry_cost_"+cnt_val).val() + "|" + $("#no_share_val_"+cnt_val).text();
        } else {
            stratergy_table_data_string += "##"+$("#invested_cost_"+cnt_val).val() + "|" + $("#entry_cost_"+cnt_val).val() + "|" + $("#no_share_val_"+cnt_val).text();
        }        
    });

    $("#cm_type_excel").val(cm_type);
    $("#cmc_strategy_for_excel").val(cm_strategy_for);
    ...
    $("#current_price_excel").val(stock_price);
    ...
    $("#avg_price_val_excel").val(avg_price_val);
    ...
    $("#stratergy_table_values .purchase_date").each(function (index, value) {   
        ...
        if(cnt_val < cnt_id) {
            ...
            if($("#stock_buy_date"+cnt_val).val() != '' && $("#invested_cost_"+cnt_val).val() > 0 && $("#entry_cost_"+cnt_val).val() > 0 ) {
                ...
                if(cm_strategy_for == "SELL") {
                    shares_to_buy = ($("#invested_cost_"+cnt_val).val() * $("#entry_cost_"+cnt_val).val());
                } else {
                    shares_to_buy = ($("#invested_cost_"+cnt_val).val() / $("#entry_cost_"+cnt_val).val());
                }
                /*shares_to_buy = ($("#invested_cost_"+cnt_val).val() / $("#entry_cost_"+cnt_val).val()).toFixed(5);*/
console.log("shares_to_buy :: Befor:::===== "+shares_to_buy);
                if(shares_to_buy < 1) {
                    shares_to_buy = shares_to_buy.toFixed(6);
                } else {
                    shares_to_buy = shares_to_buy.toFixed(2);
                }
console.log("shares_to_buy :: After :::===== "+shares_to_buy);
                new_total_entry = +(new_total_entry) + +($("#entry_cost_"+cnt_val).val() * shares_to_buy);
                
                total_share_buy = (+(total_share_buy) + +(shares_to_buy)).toFixed(6);

                ave_price_per_token = (sum_total_invested / total_share_buy).toFixed(2);

                $("#real_cost_"+cnt_val).empty().html($("#invested_cost_"+cnt_val).val());
                $("#no_share_val_"+cnt_val).empty().html(shares_to_buy);
                $("#tot_no_share_val_"+cnt_val).empty().html(total_share_buy);
                $("#ave_price_per_token_"+cnt_val).empty().html(ave_price_per_token);
                enable_checkbox(index);
            } else {
...
//console.log("sum_total_invested == "+sum_total_invested);
//console.log("total_share_buy == "+total_share_buy);
        ...
        if(sum_total_invested > 0 && total_share_buy > 0) {
            ...
            if(cm_strategy_for == "SELL") {
                ...
                if(total_share_buy < 1){
                    $("#tot_invseted").empty().html(parseFloat(total_share_buy).toFixed(6));
                } else {
                    $("#tot_invseted").empty().html(parseFloat(total_share_buy).toFixed(2));
                }                
                ...
                $("#total_cost").empty().html(total_cost.toFixed(2));
                total_invseted = $("#tot_invseted_input").val();
                var new_total_inveted = sum_total_invested;
                
                if(new_total_inveted < 1){
                    $("#tot_invseted").empty().html(parseFloat(new_total_inveted).toFixed(6));
                } else {
                    $("#tot_invseted").empty().html(parseFloat(new_total_inveted).toFixed(2));
                }                 
        ...
        if(new_total_gainLoss >= 0){
            if(new_total_gainLoss < 1) {
                $("#total_gain").empty().html(new_total_gainLoss.toFixed(6)).css('color','#67c275');
            } else {
                $("#total_gain").empty().html(new_total_gainLoss.toFixed(2)).css('color','#67c275');
            }            
            $(".reult-stratergy i").attr('class', 'fa fa-arrow-up');
            $(".reult-stratergy i").css('color','#67c275');
        }else{
            if(new_total_gainLoss < 1) {
                $("#total_gain").empty().html(new_total_gainLoss.toFixed(6)).css('color','red');
            } else {
                $("#total_gain").empty().html(new_total_gainLoss.toFixed(2)).css('color','red');
            }
        ...
        if(cm_strategy_for == "SELL") {
            ...
            if(new_total_inveted < 1){
                $("#tot_amt_share").empty().html(parseFloat(new_total_inveted).toFixed(6));
            } else {
                $("#tot_amt_share").empty().html(parseFloat(new_total_inveted).toFixed(2));
            }

            if(avg_price < 1){
                $("#avg_all_share_price").empty().html(parseFloat(avg_price).toFixed(6));
            } else {
                $("#avg_all_share_price").empty().html(parseFloat(avg_price).toFixed(2));
            }
            
            if(diff_price < 1){
                $("#diff_price").empty().html(parseFloat(diff_price).toFixed(6));
            } else {
                $("#diff_price").empty().html(parseFloat(diff_price).toFixed(2));
            }
            ...
            if(total_share_buy < 1){
                $("#tot_amt_share").empty().html(parseFloat(total_share_buy).toFixed(6));
            } else {
                $("#tot_amt_share").empty().html(parseFloat(total_share_buy).toFixed(2));
            }
