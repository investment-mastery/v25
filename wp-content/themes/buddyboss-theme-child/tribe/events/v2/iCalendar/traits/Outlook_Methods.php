...
trait Outlook_Methods {
	...
	public function generate_outlook_subscribe_url( View $view = null ) {
		...
		$string = '';
		if($currntShortCode == 'shortcode=e36be2d3')
			{
				$string = 'Your Trading Club Calendar 1';
			}
		elseif($currntShortCode == 'shortcode=29f2a7ec')
			{
				$string = 'Your Crypto Club Calendar';
			}
			else{
				$string = 'Gold Fast-Track Calendar';
			}
		...
		/*get_bloginfo( 'name' ) . ' ' . $view->get_title()*/
