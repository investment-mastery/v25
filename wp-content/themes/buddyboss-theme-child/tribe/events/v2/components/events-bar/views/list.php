...
>
	<ul class="tribe-events-c-view-selector__list">
		<?php
		$new_public_views['month'] =$public_views['month'];
		$new_public_views['week'] =$public_views['week'];
		$new_public_views['day'] =$public_views['day'];
		?>
		<?php foreach ( $new_public_views as $public_view_slug => $public_view_data ) : ?>
			<?php $this->template(
