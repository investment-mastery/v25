<?php
/*
 * Template name: CCA Download Excel
 *
 */
ob_clean();
// echo "<pre>";
     ...
     <div style="width:100%; float:left; padding-bottom: 30px; padding-top: 30px;">
     	<table style="width:90%;">
		  ...
		  <tr>
		    ...
		    <td style="font-size:20px; text-align: center;" class="yellow-box"><?php echo $_REQUEST['current_price']?></td>
...
<br /><br /><br />
		...
		<table style="width:30%; border:none; margin-top: 40px;">
		  ...
		  <tr style="font-size: 20px;">
		  	<th class="blue-box" style="text-align:center;">-20%</th>
		    <th class="yellow-box">15000.10</th>  
		  </tr>
		</table>
