...
if( is_user_logged_in() ) {
			...
			<div class="ab-sub-wrapper wrapper">
				<ul id="wp-admin-bar-my-account-forums-default" class="ab-submenu">
					<li id="wp-admin-bar-my-account-forums-topics">
						<a class="ab-item" href="/forums"><?php _e( 'Forums', 'buddyboss-theme' ); ?></a>
					</li>
					<li id="wp-admin-bar-my-account-forums-topics">
	...
	*/
	...
	printf( "<li class='logout-link'><a href='%s'>%s</a></li>", wp_logout_url( get_home_url() ), __( 'Log Out', 'buddyboss-theme' ) );
}
