 ...
 */
.buddypanel.gold-fasttrack-sidebar, .buddypanel.gold-fasttrack-sidebar .panel-head {
    background: #222;
}
...
.buddypanel.gold-fasttrack-sidebar .panel-head {
...
.buddypanel.gold-fasttrack-sidebar .current-menu-item a {
    background: #333;
}
