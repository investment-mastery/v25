<?php
/*
 * Template name: CCA My Alerts Template
 *
 */
...
<div class="container-fluid vca-cca-calculator" id="allData">
    <div class="col-lg-12 col-sm-12">       
        <div class="entry-header tab">
            ...
            <a class="tablinks" href="/cca-my-strategy">My Strategies</a>
...
@media (min-width: 1381px) and (max-width: 1440px){
    ...
    .elementor-column.elementor-col-100.elementor-top-column.elementor-element.elementor-element-94d3085 {
        margin-top: -7%;
    }
    select#currency_search {
        width: 98%;
    }
 } 
...
function getRecapData(entryLvl, strategyid, strategyname, stockname, currency, weekhigh, investment_total, stockprice) {
    ...
    let currencySymbol          = {"USD":'&#36;', "GBP":'&pound;', "EUR":'&euro;', "AUD":'A&#36;', "BTC":'₿'};
...
$(document).ready(function () {
    ...
    function fetch_alert_data(calc_type = 'CCA', start_date = '', end_date = '', stock_name ='', currency = '', alert_for = '', search_keyword = '') {
    ...
    $('#sevieces_tbl_date').daterangepicker(
          ...
          function (start, end) {       
            ...
            fetch_alert_data('CCA', start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'), $( "#stock_filter" ).val(), $("#currency_search").val(), $("#alert_search").val(), $('#txtSearch').val());
          }
        );
    ...
    $( "#stock_filter" ).on('autocompleteselect', function (e, ui) {
        ...
        fetch_alert_data('CCA', filter_start_date, filter_end_date, myArray[0], $("#currency_search").val(), $("#alert_search").val(), $('#txtSearch').val());        
    });
    ...
    $('body').on('keydown', '#txtSearch', function(e) {
        if (e.which == 9 || e.which == 13) {
            ...
            fetch_alert_data('CCA', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $("#currency_search").val(), $("#alert_search").val(), $('#txtSearch').val());  
        }
    });

    $(document.body).on("click",".select-dropdown__list--0 .select-dropdown__list-item",function() {
        fetch_alert_data('CCA', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $(this).data("value"), $("#alert_search").val(), $('#txtSearch').val()); 
        //alert("Alert for == "+$(this).data("value"));
    });

    $(document.body).on("click",".select-dropdown__list--1 .select-dropdown__list-item",function() {
        fetch_alert_data('CCA', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $("#currency_search").val(), $(this).data("value"), $('#txtSearch').val()); 
        //alert("Alert for == "+$(this).data("value"));
    });
