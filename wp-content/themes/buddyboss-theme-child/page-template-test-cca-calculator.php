<?php
/*
 * Template name:Test CCA Template
 *
 */
...
<div class="container vca-cca-calculator" id="allData">
    <div class="row">
       <div class="tab_mobile_scroll">  
        <div class="entry-header tab">
            ...
            <a class="tablinks" onclick="openContent(event, 'test-cca')">Strategy</a>
            <a class="tablinks" onclick="saveStrategyAlert('/test-cca-strategy')">My Strategies</a>
            <!-- <a class="tablinks" onclick="saveStrategyAlert('/cca-my-alerts')">My Alerts <span id="alert_notify_cnt"></span></a> -->
        </div>
      </div>    
        <p class="x-error"></p>
    </div>
  <div class="watchnow">    <?php echo do_shortcode( '[elementor-template id="18155"]' ); ?></div>
    ...
    <div class="tab-content" id="fullpage">
            ...
            <div class="row" id="test">
                <div class="col-lg-4  col-sm-12">
                    <div class="percent1" id="stock_div">
                        <h4 style="">Crypto</h4>
                        <input type="text" class="btn-primary percent1_input" name="stock" id="stock_ticker" title="Enter Crypto" >
                    </div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="blue-box">
                        ...
                        <h3><span class="currSymbol">$</span><input type="text" name="current_high_val" id="current_high_val" title="Enter Current High Price" ></h3>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="percent1" id="high_div">
                        ...
                        <input type="number" class="btn-primary percent1_input input_num_validate" name="current_hight" id="current_hight" title="Enter Current High Price" title="Last 3 Months High">
                    ...
                    <div class="percent1" id="invest_div">
                        ...
                        <input type="number" class="btn-primary percent1_input input_num_validate" name="investment" id="investment" title="Your Total Investment Amount">
                ...
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="col-lg-4 col-sm-12">
                        <div id="div_sel_entry" class="calculate">
                            <div>
                                <select class="form-select form-select-lg form-control entry_dropdown" name="sel_entry_level" id="sel_entry_level" placeholder-text="8 -90%"  title="Select your total number of entries">
                                        <option value=""></option>
                                        <option value="4">4 -50%</option>
                                        <option value="5">5 -60%</option>
                                        <option value="6">6 -70%</option>
                                        <option value="7">7 -80%</option>
                                        <option value="8" selected>8 -90%</option>
                                </select>
                            </div>
                        </div>
                    </div>
        ...
        <div style="display:none" id="test-cca"> 
    ...
    $("#stratergy_table_values .purchase_date").each(function (index, value) {   
        ...
        if(cnt_val < cnt_id) {
            ...
            if($("#stock_buy_date"+cnt_val).val() != '' && $("#invested_cost_"+cnt_val).val() > 0 && $("#entry_cost_"+cnt_val).val() > 0 ) {
                ...
                $("#ave_price_per_token_"+cnt_val).empty().html(currencySymbol[currency]+ave_price_per_token);
                enable_checkbox(index);
            } else {
