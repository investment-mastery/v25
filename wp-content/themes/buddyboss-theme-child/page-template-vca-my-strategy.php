<?php
/*
 * Template name: VCA My Strategy Template
 *
 */
...
<div class="container-fluid vca-cca-calculator" id="allData">
    <div class="col-lg-12 col-sm-12"> 
      <div class="tab_mobile_scroll">
        <div class="entry-header tab">
            <a class="tablinks tab_first" href="/vca-calculator">VCA Calculator</a>
            <a class="tablinks" href="/vca-calculator">Strategy</a>
            <a class="tablinks active" onclick="openContent(event, 'my-strategy')">My Strategies</a>
            <a class="tablinks" href="/vca-my-alerts">My Alerts <span id="alert_notify_cnt"></span></a>
        </div>
      </div>
    </div>
    ...
    <div class="tab-content" id="fullpage">
        ...
        <div id="my-strategy" class="container tab-pane" style="padding:0">
            <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="col-lg-3 col-sm-12 my-stra-text" style="margin-left:0;">
                        <button type="button" class="btn btn-default" id="sevieces_tbl_date"S>
                            <span>
                                ...
                                <span class="date-range-lbl"><?php echo date("m-d-Y", strtotime('-8 days'))." - ".date("m-d-Y");?></span>
                            </span>
                            <i class="fa fa-angle-down date-btn"></i>
                        </button>  
                    </div>  

                    <div class="col-lg-3 col-sm-12 my-stra-text">
                        <i class="fa fa-signal mr-1 stock-icon"></i>
                        <input type="text" class="" name="stock" id="stock_filter"  value="" title="Stock Search..." placeholder="Stock" >
                    </div>
                ...
                <div class="table-responsive-lg my-strategy-table">
                    <table id="my_strategy_listing" class="table table-striped text-center display" >
                        <thead>
                            <tr>
    ...
    <div class="row d-none" style="display: none;" >
        <form method="Post" id="pdf_gen" action="/vca-download-excel/" target="_blank">
...
<div id="vca_popup" class="overlay">
        <div class="popup"  style="max-width:1100px !important;">
            ...
            <div class="content">
                    ...
                    <div class="calculate">
                        <div class="edit_header_row">
                            ...
                            <div class="edit_header_row_1_4 row_right">
                                <p>Live Stock Price <button class="edit_blue_box" id="view_header_live_price"></button></p>
                            </div>
                        </div>
                        <div class="edit_header_row">
                            <div class="edit_header_row_1 row_left">
                                <div class="edit_header_row">
                                    <div class="edit_header_row_1 row_left">
                                        <p>Stock  <button class="edit_blue_box" id="view_header_stock_name"></button></p>
                                    </div>
                            ...
                            <div class="edit_header_row_1 row_left edit_header_outer_left">
                                <div class="edit_header_row">
                                    ...
                                    <div class="edit_header_row_1 row_right edit_header_outer_div_right">
                                        <div class="edit_header_top_div">Total Amount of Shares</div>
                ...
                <div class="content_edit" id="strategy_edit_tab_content">
                    <div class="calculate">
                        <div class="edit_header_row">
                            <div class="edit_header_row_1_3 row_left" id="edit_strategy_name">
                            ...
                            <div class="edit_header_row_1_4 row_right">
                                <p>Live Stock Price <button class="edit_blue_box" id="edit_header_live_price"></button></p>
                            </div>
                        </div>
                        <div class="edit_header_row">
                            <div class="edit_header_row_1 row_left">
                                <div class="edit_header_row">
                                    <div class="edit_header_row_1 row_left">
                                        <p>Stock  <button class="edit_blue_box" id="edit_header_stock_name"></button></p>
                                    </div>
                                    <div class="edit_header_row_1 row_right">
                            ...
                            <div class="edit_header_row_1 row_right">
                                <div class="edit_header_row_1 row_left">
                                    <p id="edit_header_investment_p">Total Investment <button class="edit_blue_box" id="edit_header_investment"></button></p>
                        ...
                        <table class="table table-striped text-center" id="edit_strategy_table" style="background-color:#efefef;">
                            <thead style="text-align: center;">
                                <tr>
                                    ...
                                    <th>Shares</th>
                                    <th>Cost</th>
                                    <th>Alerts <span id="chek_show_all" style="display:none;"><input type="checkbox" name="checkAll" id="checkAll"></span></th>
                                </tr>
                            </thead>
                    ...
                    <div style="clear: both;">
                        <div class="edit-link-div">
                           <a href="/vca-calculator"> <button type="button" class="btn-calculate"><i class="fa fa-calculator" aria-hidden="true"></i>VCA Calculator</button></a>
                ...
                <div id="strategy_profit_tab_content">
                    <div class="calculate">
                        <div class="edit_header_row">
                            ...
                            <div class="edit_header_row_1_4 row_right">
                                <p>Live Stock Price <button class="edit_blue_box" id="profit_header_live_price"></button></p>
                        ...
                        <div class="edit_header_row">
                            <div class="edit_header_row_1 row_left">
                                <div class="edit_header_row">
                                    <div class="edit_header_row_1 row_left">
                                        <p>Stock  <button class="edit_blue_box" id="profit_header_stock_name"></button></p>
                                    </div>
                                    <div class="edit_header_row_1 row_right">
                            ...
                            <div class="edit_header_row_1 row_right">
                                <div class="edit_header_row_1 row_left">
                                    <p id="profit_header_investment_p">Total Investment <button class="edit_blue_box" id="profit_header_investment"></button></p>
                    ...
                    <div class="calculate">
                        ...
                        <div class="edit_header_row">
                            ...
                            <div class="edit_header_row_1 row_right edit_header_outer_right">
                                <div class="edit_header_row">
                                    <div class="edit_header_row_1 row_left edit_header_outer_div_left">
                                        <div class="edit_header_top_div">Total Amount of Shares Sold</div>
    ...
    <div id="delete_popup" class="overlay">
        <div class="popup" style="max-width:600px !important;">
            <a class="close close_popup" data-popup="#delete_popup">&times;</a>
            <div class="content" style="text-align: center !important;">
                ...
                <p style="font-size: 36px; font-weight: bold; line-height: 50px;">Are you sure?</p>
                <p style="font-size: 24px; line-height: 35px;">You won't be able to revert this!</p>
                <p>
                    <button type="button" class="btn-light delete_yes">YES, DELETE IT</button> 
                    <button type="button" class="btn-light close_popup" data-popup="#delete_popup">NO</button>
                    <input type="hidden" name="delete_strategy_id" id="delete_strategy_id">
                </p>
            </div>
            <div class="delete_content_success"><h3>You have deleted your strategy successfully.</h3></div>
        </div>
    </div>
...
#my_strategy_listing .first_row {
    width: 120px !important;
}

#my_strategy_listing .last_row {
...
.date-range-lbl {
    ...
    @media screen and (max-width: 1482px) and (min-width: 1402px) {
    .my-stra-text1{
        width: 30%;
    }
    .my-stra-text{
...
$("#my_strategy_listing").on("click", ".open_popup", function(){

    if($(this).data("action") == 'delete') {

        $("#delete_popup .content").css("display", "block")
        $("#delete_popup .delete_content_success").css("display", "none");
console.log("Strategy to delete === "+$(this).data("strategyid"));
        $("#delete_strategy_id").val($(this).data("strategyid"));
...
function getRecapData(entryLvl, strategyid, strategyname, stockname, currency, weekhigh, investment_total, stockprice) {
    ...
    $.each(entery_level_arr, function (index, value) {
        ...
        var investment =   Math.round(investment_total * prev_per_tot_amt  / 100);
        ...
        /*poonam added 17apr*/
        if(entery_price > 1){
            var new_set_entry_price = entery_price.toFixed(2);
        }else{
            var new_set_entry_price = entery_price.toFixed(4);
        }
    ...
    if(weekhigh > 1) {
        $("#view_header_curr_high").empty().html(currencySymbol[currency]+parseFloat(weekhigh).toFixed(2));
    } else {
        $("#view_header_curr_high").empty().html(currencySymbol[currency]+parseFloat(weekhigh).toFixed(5));
    }

    $("#view_header_currency").empty().text(currency);
    $("#view_header_investment").empty().html(currencySymbol[currency]+parseFloat(investment_total).toFixed(2));
    ...
    $("#view_header_total_invest").empty().html(currencySymbol[currency]+parseFloat(investment_total).toFixed(2));
    $("#view_header_total_share").empty().html(tot_no_of_share_buy);
     /*RAM MODIFIED ON 23NOV*/
     if(avg_price_show >1)
     {
        $("#view_header_average_price").empty().html(currencySymbol[currency]+parseFloat(avg_price_show).toFixed(2));
     }else{
         $("#view_header_average_price").empty().html(currencySymbol[currency]+parseFloat(avg_price_show).toFixed(6));
     }
...
$(document).ready(function () {
    ...
    function fetch_strategy_data(calc_type = 'VCA', start_date = '', end_date = '', stock_name ='', currency = '', search_keyword = '') {

        $('#my_strategy_listing').DataTable().destroy();

        $('#my_strategy_listing').DataTable({
            processing: true,
            serverSide: true,
            searching: false,
            ordering: false,
        ...
        $("#my_strategy_listing th").removeClass("sorting_asc");
        $('div.toolbar').html('');    
    }
    ...
    $("#delete_popup").on("click", ".delete_yes", function() {
        
        var strategy_id = $("#delete_strategy_id").val();
        console.log("deleting strategy input === "+strategy_id);
        $.ajax({
            url: `${apiBaseurl}/delete-vca`,
            data : {
            ...
            success: (data) => {
                $("#delete_popup .content").css("display", "none")
                $("#delete_popup .delete_content_success").css("display", "block");
                setTimeout(function() { 
    ...
    $("#strategy_edit_tab_content").on("blur", "#edit_header_investment_input", function() {
        ...
        $("#edit_header_investment_p").empty().html('Total Investment <button class="edit_blue_box" id="edit_header_investment">'+currencySymbol_val+new_investment+'</button>');  
    ...
    $("#strategy_profit_tab_content").on("blur", "#profit_header_investment_input", function() {
        ...
        $("#profit_header_investment_p").empty().html('Total Investment <button class="edit_blue_box" id="profit_header_investment">'+currencySymbol_val+new_investment+'</button>');  
    ...
    function recalculate_strategy(strategy_id, new_investment) {
        ...
        $("#edit-Strategy-table-body .purchase_date").each(function (index, value) {
            ...
            if($("#edit_stock_buy_date"+cnt_val).val() == "") {
                totalEmptyEntries++;
                new_details_id++;
                entryPriceArr[totalEmptyEntries] = $("#edit_entry_cost_hidden_"+cnt_val).val();
                details_id[new_details_id] = $("#details_id_"+cnt_val).val();
            }
        ...
        /*poonam added 12apr*/
        var new_total_invested = totalInvestedTillDate.replace(/\$/g, "");
        // var remaining_investment = (new_investment - totalInvestedTillDate);
        /*end poonam added 12apr*/

        var remaining_investment = (new_investment - new_total_invested);
        var entery_level_arr        = new Array();
        ...
        $.each(entery_level_arr, function (index, value) {
            ...
            /*poonam added 15apr */
            my_strategy_detail.push({'investment_amount':strategy_investment, 'entry_price':entryPriceArr[index+1],'details_id':details_id[index+1]})
            /*end poonam added 15apr */       

            // console.log("strategy_investment");           
            // console.log(strategy_investment);  
            // console.log("remaining_investment");           
            // console.log(remaining_investment);           
        });
    ...
    $(document).on("click", "#update_stratergy", e => {
        ...
        $('#txtStrategyName').removeClass("error");      
            ...
            var temp_strategy = {
                ...
                "total_investment": $("#edit_header_total_invest").html().slice(1), 
            ...
            $("#edit-Strategy-table .date_box").each(function (index, value) {   
                cnt_val = index ;
                // console.log("This is Purchase date="+strategy_detail[index]['purchase_date']); 
                // die();
            ...
            $("#profit_tbl_body .sale_date").each(function (index, value) {   
                ...
                /*poonam added 2may*/
                var store_profit_header_price_diff = $("#profit_header_price_diff").text().replace(/\$/g, '');
                var store_profit_header_gain_loss = $("#profit_header_gain_loss").text().replace(/\$/g, '');
                var store_profit_header_result = $("#profit_header_result").text().replace(/\$/g, '');

                profit_detail[index]['profit_header_total_sold'] = $("#profit_header_total_sold").text(); 
                profit_detail[index]['profit_header_price_diff'] = store_profit_header_price_diff; 
                profit_detail[index]['profit_header_gain_loss'] = store_profit_header_gain_loss; 
                profit_detail[index]['profit_header_result'] = store_profit_header_result; 
    ...
    /*Update Stratergy : END */
     ...
     $('#sevieces_tbl_date').daterangepicker(
          ...
          function (start, end) {       
            ...
            fetch_strategy_data('VCA', start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'), $( "#stock_filter" ).val(), $("#currency_search").val(), $('#txtSearch').val());
          }
        ); 
    ...
    $( "#stock_filter" ).on('autocompleteselect', function (e, ui) {
        ...
        fetch_strategy_data('VCA', filter_start_date, filter_end_date, myArray[0], $("#currency_search").val(), $('#txtSearch').val());        
    });
    ...
    $('body').on('keydown', '#txtSearch', function(e) {
        if (e.which == 9 || e.which == 13) {
            ...
            fetch_strategy_data('VCA', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $("#currency_search").val(), $('#txtSearch').val());  
        }
    });

    $(document.body).on("click",".select-dropdown__list-item",function() {
        fetch_strategy_data('VCA', filter_start_date, filter_end_date, $( "#stock_filter" ).val(), $(this).data("value"), $('#txtSearch').val()); 
    });    
   
});

$(window).on('load', function() {
  $(".select-dropdown__button--0 span").html("Currency");
});
    ...
    function downloadExcel(){
        ...
        var strategy_name = $("#edit_entery_level_val").val();
   ...
   function edit_cost(cnt_id){
        ...
        $("#edit-Strategy-table-body .purchase_date").each(function (index, value) {   
            ...
            if($("#edit_stock_buy_date"+cnt_val).val() != '' && $("#edit_invested_cost_"+cnt_val).val() > 0 && $("#edit_entry_cost_"+cnt_val).val() > 0 ) {
                ...
                investment_inc_balance_amt = +($("#edit_invested_cost_"+cnt_val).val()) + +(balance_amount);

                total_cost = +(total_cost) + +($("#edit_cost_"+cnt_val).val());

                shares_to_buy = Math.round(investment_inc_balance_amt / $("#edit_entry_cost_"+cnt_val).val());

                 new_total_entry = +(new_total_entry) + +($("#edit_entry_cost_"+cnt_val).val() * shares_to_buy);
                ...
                /*poonam 5apr*/
                balance_amount = investment_inc_balance_amt - ($("#edit_entry_cost_"+cnt_val).val() * shares_to_buy);
                /*end*/

                //adsd = $("#edit_entry_cost_"+cnt_val).val();  
                // console.log("investment_inc_balance_amt amount ==== "+investment_inc_balance_amt);
                // console.log("adsd amount ==== "+adsd);
                // console.log("shares_to_buy amount ==== "+shares_to_buy);
                // console.log("balcance amount ==== "+balance_amount);

                //real_cost = investment_inc_balance_amt;

                /*poonam 04 Apr*/
                 real_cost = $("#edit_entry_cost_"+cnt_val).val() * shares_to_buy;
                /* end poonam 04 Apr*/

                 //console.log("as amount ==== "+as);

                $("#edit_real_cost_"+cnt_val).empty().html(currencySymbol[currency]+real_cost.toFixed(2));
                $("#edit_no_share_val_"+cnt_val).empty().html(shares_to_buy);
                $("#edit_balance_cost_"+cnt_val).empty().html(currencySymbol[currency]+balance_amount.toFixed(2));
                enable_checkbox(index);
            } else {
        ...
        $("#edit_total_amt_share_val").val(total_share_buy.toFixed(1));
        $("#edit_entery_tbl_no_shares1").val(total_share_buy.toFixed(1));
        ...
        $("#edit_header_total_share").empty().html(total_share_buy.toFixed(1));
    ...
    if(avg_price > 0 && total_tokens > 0) { 
        ...
        $("#profit_tbl_body .sale_date").each(function (index, value) {   
            ...
            if($("#edit_stock_sale_date"+cnt_val).val() != '' && $("#edit_your_fiat_sale_sum_"+cnt_val).val() > 0 && $("#edit_your_take_profit_price_"+cnt_val).val() > 0) {  
                ...
                if(cnt_val == 0) {
                    sale_sum = current_holdings_prev * take_profit_price;
                } else {
    ...
    if(avg_price > 0 && total_tokens > 0) { 
        ...
        $("#profit_tbl_body .sale_date").each(function (index, value) {   
            ...
            if($("#edit_stock_sale_date"+cnt_val).val() != '' && $("#edit_your_fiat_sale_sum_"+cnt_val).val() >= 0 && $("#edit_your_take_profit_price_"+cnt_val).val() >= 0) {
                ...
                /*poonam added 2may*/
                var new_value_cal = take_profit_price * total_tokens;
                var get_average_price = $("#profit_header_average_price").text();
                var return_avg_price = get_average_price.replace(/\$/g, '');
                var after_change_diff_price = take_profit_price - return_avg_price;
                var after_change_gain_loss_price = after_change_diff_price * total_tokens;
                var get_total_invested_price = $("#edit_header_total_invest").text();
                var return_get_total_invested_price = get_total_invested_price.replace(/\$/g, '');
                var after_change_result_price = (after_change_gain_loss_price/return_get_total_invested_price)*100;
                
                $("#profit_header_total_sold").empty().html(currencySymbol[currency]+parseFloat(new_value_cal).toFixed(2)); 
                $("#profit_header_price_diff").empty().html(currencySymbol[currency]+parseFloat(after_change_diff_price).toFixed(2)); 
                $("#profit_header_gain_loss").empty().html(currencySymbol[currency]+parseFloat(after_change_gain_loss_price).toFixed(2));
                $("#profit_header_result").empty().html(currencySymbol[currency]+parseFloat(after_change_result_price).toFixed(2)); 
                /*end poonam added 2may*/
        ...
        $("#profit_header_current_holding_value").empty().html('0.00');
        //$("#profit_header_total_sold").empty().html(currencySymbol[currency]+parseFloat(total_sale_sum).toFixed(2)); 

        /*poonam added 23apr*/
        if(total_tokens >1) {
            $("#profit_header_total_share_sell").empty().html(Math.abs(total_tokens).toFixed(2));
            $("#profit_header_holding_share").empty().html('0.00000');
        }else{
            $("#profit_header_total_share_sell").empty().html(Math.abs(total_tokens).toFixed(5));
            $("#profit_header_holding_share").empty().html('0.00000');
        } 
        /*end poonam added 23apr*/
...
/*Edit Stratergy Data Fetching : START  */
    function getStrategyDetails(strategy_id) {
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                getChartData(data['strategy'][0]['stock_name']);
                ...
                for (var i = 0; i < data['details'].length; i++) {
                    ...
                    if(data['details'][i]['purchase_date'] != '0000-00-00') {                        
                        investment_inc_balance_amt = +(data['details'][i]['investment_amount']) + +(balance_amount);
                        balance_amount = investment_inc_balance_amt - (data['details'][i]['entry_price'] * data['details'][i]['no_of_shares_to_buy']);
                    ...
                    /*poonam added 11apr*/
                    var checkbox_checked_value = data['details'][i]['alert_flag'];
                    if(checkbox_checked_value == 0){
                        $("#chek_show_all").show();
                    }
                    /*end poonam added 11apr*/

                    var checked_status = '';
                    if(data['details'][i]['alert_flag'] == 1) {
                        checked_status = 'checked';
                    } else if(data['details'][i]['alert_flag'] == 2) {
                        //checked_status = 'disabled';
                        checked_status = 'checked';
                    } else {
                        checked_status = '';
                    }
                    ...
                    if(data['details'][i]['entry_price'] > 1) {
                        var d_detail_entry_price = parseFloat(data['details'][i]['entry_price']).toFixed(2);
                        /*poonam added 12 apr*/
                        var d_detail_entry_price_hidden = parseFloat(data['details'][i]['entry_price']);
                        var d_detail_entry_details_id = data['details'][i]['detail_id']; 
                        /*end poonam added 12 apr*/
                    } else {
                        var d_detail_entry_price = parseFloat(data['details'][i]['entry_price']).toFixed(6);
                        /*poonam added 15 apr*/
                        var d_detail_entry_price_hidden = parseFloat(data['details'][i]['entry_price']);
                        var d_detail_entry_details_id = data['details'][i]['detail_id'];         
                       // console.log(d_detail_entry_details_id);       
                        /*end poonam added 15 apr*/
                    }

                    table_body +='<tr><td class="edit_entry_lvl_td"> -'+entery_level_arr[i]+'%</td><td> <input type="date" class="date_box purchase_date" name="edit_stock_buy_date'+i+'" id="edit_stock_buy_date'+i+'" value="'+data['details'][i]['purchase_date']+'" onchange="setdatetospan(this.id, '+cnt+'); edit_cost('+i+');" required><span class="d-none" style="display:none;" id="span_stock_buy_date'+i+'"> </span><input type="hidden" class="form-control entry_val input_num_validate" name="details_id_'+i+'" id="details_id_'+i+'" value="'+d_detail_entry_details_id+'"></td><td>'+currency_symbol+' <input type="number" class="form-control invested_val input_num_validate" name="edit_invested_cost_'+i+'" id="edit_invested_cost_'+i+'" value="'+data['details'][i]['investment_amount']+'" onkeyup="edit_cost('+i+')"></td><td><span class="balance_val" name="edit_balance_cost_'+i+'" id="edit_balance_cost_'+i+'" >'+currency_symbol+balance_amount.toFixed(2)+'</span></td><td><span class="real_val" name="edit_real_cost_'+i+'" id="edit_real_cost_'+i+'" >'+currency_symbol+''+real_cost.toFixed(2)+'</span></td><td>'+currency_symbol+' <input type="number" class="form-control entry_val input_num_validate" name="edit_entry_cost_'+i+'" id="edit_entry_cost_'+i+'" value="'+d_detail_entry_price+'" onkeyup="edit_cost('+i+')"><input type="hidden" class="form-control entry_val input_num_validate" name="edit_entry_cost_'+i+'" id="edit_entry_cost_hidden_'+i+'" value="'+d_detail_entry_price_hidden+'" onkeyup="edit_cost('+i+')"></td><td><span class="no_share_val" id="edit_no_share_val_'+i+'">'+parseInt(data['details'][i]['no_of_shares_to_buy'])+'</span></td><td>'+currency_symbol+' <input type="number" class="form-control investment_val input_num_validate" name="edit_cost_'+i+'" id="edit_cost_'+i+'" value="'+data['details'][i]['additional_cost']+'" onkeyup="edit_cost('+i+')"><input type="hidden" name="no_of_share_buy_'+i+'" id="no_of_share_buy_'+i+'" value="'+data['details'][i]['no_of_shares_to_buy']+'"><span id="span_cost_'+i+'" class="d-none" style="display:none;"></span></td><td><input type="checkbox" name="edit_chkSetAlert_'+i+'" id="edit_chkSetAlert_'+i+'" class="alert_chk" '+checked_status+'></td></tr>';
                ...
                table_body += '<tr class="yellow-box"> <td colspan="6"></td> <td class="total">Total Cost</td><td class="total"><span id="edit_total_cost">'+currency_symbol+''+total_cost.toFixed(2)+'</span></td> </tr>';
                /* alert(table_body); */              
                ...
                /*poonam added 26apr*/
                $("#edit_header_live_price").empty().html(currency_symbol+parseFloat(data['strategy'][0]['stock_price']).toFixed(2));
                $("#view_header_live_price").empty().html(currency_symbol+parseFloat(data['strategy'][0]['stock_price']).toFixed(2));
                /*end pooonam added 26apr*/
                $("#edit_header_stock_name").empty().text(data['strategy'][0]['stock_name']);
                
                if(data['strategy'][0]['52_week_high'] > 1) {
                    $("#edit_header_curr_high").empty().html(currency_symbol+parseFloat(data['strategy'][0]['52_week_high']).toFixed(2));
                } else {
                    $("#edit_header_curr_high").empty().html(currency_symbol+parseFloat(data['strategy'][0]['52_week_high']).toFixed(5));
                }
                
                $("#edit_header_currency").empty().text(data['strategy'][0]['currency']);
                $("#edit_header_investment").empty().html(currency_symbol+parseFloat(data['strategy'][0]['your_investment']).toFixed(2));
               ...
               // $("#edit_header_total_invest").empty().html(currency_symbol+data['strategy'][0]['total_investment']);
                $("#edit_header_total_share").empty().html(parseFloat(data['strategy'][0]['total_share_buy']).toFixed(1));
                ...
                /*RAM MODIFIED ON 23NOV23*/
                if(data['strategy'][0]['total_investment']>1)
                {
                    $("#edit_header_total_invest").empty().html(currency_symbol+parseFloat(data['strategy'][0]['total_investment']).toFixed(2));
                }else{
                    $("#edit_header_total_invest").empty().html(currency_symbol+parseFloat(data['strategy'][0]['total_investment']).toFixed(6));
                }
                ...
                {
                    $("#edit_header_average_price").empty().html(currency_symbol+parseFloat(data['strategy'][0]['average_share_price']).toFixed(2));
                }else{
                    $("#edit_header_average_price").empty().html(currency_symbol+parseFloat(data['strategy'][0]['average_share_price']).toFixed(6));
                }
                /*RAM MODIFIED ON 23NOV23*/
                if(data['strategy'][0]['share_price_difference']>1)
                {
                    $("#edit_header_price_diff").empty().html(currency_symbol+parseFloat(data['strategy'][0]['share_price_difference']).toFixed(2));
                }else{
                    $("#edit_header_price_diff").empty().html(currency_symbol+parseFloat(data['strategy'][0]['share_price_difference']).toFixed(6));
                }
                ...
                if(data['strategy'][0]['total_gain_loss']>1){
                   var total_gain_loss_ne =  parseFloat(data['strategy'][0]['total_gain_loss']).toFixed(2);
                }else{
                     var total_gain_loss_ne =  parseFloat(data['strategy'][0]['total_gain_loss']).toFixed(6);
                }

                if(data['strategy'][0]['total_gain_loss'] >= 0) {

                    $("#edit_header_gain_loss").empty().html(currency_symbol+total_gain_loss_ne+" <i class='fa fa-arrow-up' aria-hidden='true'></i>");            
                    $("#edit_header_gain_loss").css('color','#67c275');
                } else {
                    $("#edit_header_gain_loss").empty().html(currency_symbol+total_gain_loss_ne+" <i class='fa fa-arrow-down' aria-hidden='true'></i>");            
                    $("#edit_header_gain_loss").css('color','red');
                }
    ...
    function getStrategyProfitData(data) {
        ...
        for (var i = 0; i < data['profits'].length; i++) {
            ...
            if(data['profits'][i]['number_of_tokens'] == 0) {
                var number_of_tokens_new = parseFloat(data['profits'][i]['number_of_tokens']).toFixed(2);
            } else if(data['profits'][i]['number_of_tokens'] != 0 && data['profits'][i]['number_of_tokens'] < 1) {
                var number_of_tokens_new = parseFloat(data['profits'][i]['number_of_tokens']).toFixed(6);
            } else {
                var number_of_tokens_new = parseFloat(data['profits'][i]['number_of_tokens']).toFixed(2);
            }
             /*RAM MODIFIED ON 17NOV23*/  
              var chkBox = '';
            if(total_tokens > 0)
            {
              var chkBox =  '<input type="checkbox" name="profit_chkSetAlert_'+i+'" id="profit_chkSetAlert_'+i+'" class="alert_chk" '+checked+'>';              
            } 
            /*RAM MODIFIED ON 23NOV23*/  
             //  var sale_sum_value = data['profits'][i]['sale_sum'];
             // if(sale_sum_value>1)
             //    {
             //        var sale_sum_value = parseFloat(sale_sum_value).toFixed(2);
             //    }else{
             //        var sale_sum_value = parseFloat(sale_sum_value).toFixed(6);
             //    }
            /*poonam added 7may*/
            var new_val = parseFloat(total_tokens * take_profit_price_new  * ( 20 / 100)).toFixed(2);       
            /*end poonam added 7may*/ 
                    
            table_body +='<tr><td><input type="date" class="date_box sale_date" name="edit_stock_sale_date'+i+'" id="edit_stock_sale_date'+i+'" value="'+data['profits'][i]['date_sale']+'" onchange="setdatetospan(this.id, '+cnt+'); edit_profit();" required><span class="d-none" style="display:none;" id="span_stock_sale_date'+i+'"> </span></td><td>'+currency_symbol+'<span class="no_share_val" id="edit_sale_sum_'+i+'">'+new_val+'</span></td><td> '+entery_level_arr[i]+'%</td><td>'+currency_symbol+' <input type="number" class="form-control invested_val input_num_validate" name="edit_your_fiat_sale_sum_'+i+'" id="edit_your_fiat_sale_sum_'+i+'" value="'+data['profits'][i]['your_fiat_sale_sum']+'" onkeyup="edit_profit()"></td><td>'+currency_symbol+'<span class="no_share_val" id="edit_take_profit_price_'+i+'">'+take_profit_price_new+'</span></td><td>'+currency_symbol+' <input type="number" class="form-control entry_val input_num_validate" name="edit_your_take_profit_price_'+i+'" id="edit_your_take_profit_price_'+i+'" value="'+your_take_profit_price_new+'" onkeyup="edit_profit()"></td><td><span class="no_share_val" id="edit_number_of_tokens_'+i+'">'+number_of_tokens_new+'</span></td><td> <input type="number" class="form-control entry_val input_num_validate" name="edit_exchange_fees_'+i+'" id="edit_exchange_fees_'+i+'" value="'+data['profits'][i]['exchange_fees']+'" onkeyup="edit_profit()">%</td><td>'+currency_symbol+'<span class="no_share_val" id="edit_trade_cost_'+i+'">'+data['profits'][i]['trade_cost']+'</span></td><td><span class="no_share_val" id="edit_current_holding_'+i+'">'+data['profits'][i]['current_holding']+'</span></td><td>'+chkBox+'</td></tr>';
            ...
            //console.log("total_sale_sum  "+number_of_tokens_new);
            total_holding_value = total_holding_new * data['live_stock_price'];
                //console.log("total_holding_new ::: "+total_holding_value);        
            //profit_header_gain_loss = (total_holding_value + total_sale_sum) - data['strategy'][0]['total_investment'];
            price_difference = data['strategy'][0]['share_price_difference'];
            profit_header_gain_loss = number_of_tokens_new * price_difference;

            // if(total_holding_value > 0 && total_sale_sum > 0) {
            //     profit_header_gain_loss_percent = (((total_holding_value + total_sale_sum) / data['strategy'][0]['total_investment']) * 100) - 100;
            // } else {
            //     profit_header_gain_loss_percent = 3;
            // }
            ...
            console.log("total_investment ::: "+data['strategy'][0]['total_investment']); */ 
                ...
                if(data['strategy'][0]['52_week_high'] > 1) {
                    $("#profit_header_curr_high").empty().html(currency_symbol+parseFloat(data['strategy'][0]['52_week_high']).toFixed(2));
                } else {
                    $("#profit_header_curr_high").empty().html(currency_symbol+parseFloat(data['strategy'][0]['52_week_high']).toFixed(5));
                }

                $("#profit_header_currency").empty().text(data['strategy'][0]['currency']);
                $("#profit_header_investment").empty().html(currency_symbol+parseFloat(data['strategy'][0]['your_investment']).toFixed(2));
                $("#profit_header_investment_old").empty().val(parseFloat(data['strategy'][0]['your_investment']).toFixed(2));

                //$("#profit_header_result").empty().text(profit_header_gain_loss_percent.toFixed(2)+"%");
                $("#profit_header_result").empty().text(data['strategy'][0]['total_gain_loss_percentage']+"%");

                $("#profit_header_current_holding_value").empty().html(currency_symbol+Math.abs(total_holding_value).toFixed(2));
                ...
                var current_holding_tokens = total_tokens - total_token_sell;
                 ...
                 /*RAM MODIFIED ON 23NOV23*/
                if(total_token_sell >1) {
                    $("#profit_header_total_share_sell").empty().html(total_token_sell.toFixed(2));
                 }else{
                     $("#profit_header_total_share_sell").empty().html(total_token_sell.toFixed(5));   
                 }    
                 /*RAM MODIFIED ON 23NOV23*/
                 if(current_holding_tokens >1) {
                    $("#profit_header_holding_share").empty().html(Math.abs(current_holding_tokens).toFixed(2));
                 }else{
                     $("#profit_header_holding_share").empty().html(Math.abs(current_holding_tokens).toFixed(5));   
                 }    
                /*RAM MODIFIED ON 23NOV23*/
                 if(data['strategy'][0]['average_share_price'] >1) {
                    $("#profit_header_average_price").empty().html(currency_symbol+parseFloat(data['strategy'][0]['average_share_price']).toFixed(2));
                 }else{
                     $("#profit_header_average_price").empty().html(currency_symbol+parseFloat(data['strategy'][0]['average_share_price']).toFixed(6));   
                 }    

                  /*RAM MODIFIED ON 23NOV23*/
                 if(data['strategy'][0]['share_price_difference'] >1) {
                    $("#profit_header_price_diff").empty().html(currency_symbol+parseFloat(data['strategy'][0]['share_price_difference']).toFixed(2));
                 }else{
                     $("#profit_header_price_diff").empty().html(currency_symbol+parseFloat(data['strategy'][0]['share_price_difference']).toFixed(6));   
                 }    
    ...
    function getChartData(stock_name) {
        ...
        if(stock_name == "GOLD") {
            stock_name = "NYSE:GOLD";
        }
        if(stock_name == "XAU") {
            stock_name = "XAU"+$("#view_header_currency").text();
        } 
        if(stock_name == "XAG") {
            stock_name = "XAG"+$("#view_header_currency").text();
        } 
        if(stock_name == "USOIL") {
            stock_name = "USOIL";
        }
...
$("#edit_your_take_profit_price_0").change(function(){
