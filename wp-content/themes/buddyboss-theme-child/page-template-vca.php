    ...
    <div class="col-lg-12 col-sm-12">
      <div class="">  
        ...
        <div class="entry-header tab">
            ...
            <a class="tablinks" onclick="saveStrategyAlert('/vca-my-strategy')">My Strategies</a>
            <a class="tablinks" onclick="saveStrategyAlert('/vca-my-alerts')">My Alerts <span id="alert_notify_cnt"></span></a>
        </div>
       </div>
       <p class="x-error"></p>
    </div>
    ...
    function cost(cnt_id) {
        ...
        $("#stratergy_table_values .purchase_date").each(function (index, value) { 
            ...
            if($("#stock_buy_date"+cnt_val).val() != '' && $("#invested_cost_"+cnt_val).val() > 0 && $("#entry_cost_"+cnt_val).val() > 0 ) {
                ...
                // adsd = $("#entry_cost_"+cnt_val).val();  
                // console.log("investment_inc_balance_amt amount ==== "+investment_inc_balance_amt);
                // console.log("new_added_entry_cost amount ==== "+adsd);
                ...
                real_cost = $("#entry_cost_"+cnt_val).val() * shares_to_buy;
