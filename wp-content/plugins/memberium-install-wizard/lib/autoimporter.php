<?php
//https://wordpress.stackexchange.com/questions/96227/import-wordpress-xml-file-from-within-functions-php/97296
//https://gist.github.com/RalfAlbert/5473885
				...
				foreach ( $post['postmeta'] as $meta ) {
					...
					if ( $key ) {
						...
						if ( ! $value ) {
							 ...
							 *
							 * @see \Elementor\Compatibility::on_wp_import_post_meta()
							 */
