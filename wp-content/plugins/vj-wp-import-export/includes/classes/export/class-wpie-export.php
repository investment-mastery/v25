...
class WPIE_Export {
        ...
        private function get_deafult_export_type() {
                ...
                if ( \defined( 'WC_VERSION' ) || \class_exists( '\WooCommerce' ) ) {
                        ...
                        $types[ "product" ]            = __( 'WooCommerce Products', 'vj-wp-import-export' );
                        $types[ "product_reviews" ]    = __( 'Product Reviews', 'vj-wp-import-export' );
                        $types[ "product_attributes" ] = __( 'Product Attributes', 'vj-wp-import-export' );
                        $types[ "shop_order" ]         = __( 'WooCommerce Orders', 'vj-wp-import-export' );
                        $types[ "shop_coupon" ]        = __( 'WooCommerce Coupons', 'vj-wp-import-export' );
                        $types[ "shop_customer" ]      = __( 'WooCommerce Customers', 'vj-wp-import-export' );
                }
                return $types;
        }
