                ...
                if ( self::is_apache() && get_option( 'wpie_is_admin_notice_clear', false ) === false ) {
                        ...
                        if ( intval( $notice ) != 1 ) {
                                ...
                                <div class="wpie-message updated" >
                                        ...
                                        <p><b><?php echo __( 'WP Import Export : ', 'vj-wp-import-export' ); ?></b> <?php _e( "If your <b>.htaccess</b> file were writable, we could do this automatically, but it isn’t. So you must either make it writable or manually update your .htaccess with the mod_rewrite rules found under <b>WP Settings >> Permalinks</b>. Until then, the exported and imported files are not protected from direct access.", 'vj-wp-import-export' ); ?></p>
                                </div>
                                <?php
                        }
                }
