        ...
        function wpie_import_post_search_existing_item( $sections = "", $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_element">
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_cf" class="wpie_radio_label"><?php esc_html_e( 'Post Meta', 'vj-wp-import-export' ); ?></label>
                                <div class="wpie_radio_container">
                                ...
                                <div class="wpie_radio_container">
                                        ...
                                        <?php if ( $wpie_import_type == "product" ) { ?>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_general" class="wpie_checkbox_label"><strong><?php esc_html_e( 'Product General', 'vj-wp-import-export' ); ?></strong></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_sku" class="wpie_checkbox_label"><?php esc_html_e( 'SKU', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_regular_price" class="wpie_checkbox_label"><?php esc_html_e( 'Regular Price', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_sale_price" class="wpie_checkbox_label"><?php esc_html_e( 'Sale price', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_sale_price_dates" class="wpie_checkbox_label"><?php esc_html_e( 'Sale price dates', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_product_url" class="wpie_checkbox_label"><?php esc_html_e( 'Product URL', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_button_text" class="wpie_checkbox_label"><?php esc_html_e( 'Button text', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_virtual" class="wpie_checkbox_label"><?php esc_html_e( 'Virtual', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_downloadable" class="wpie_checkbox_label"><?php esc_html_e( 'Downloadable', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_downloadable_files" class="wpie_checkbox_label"><?php esc_html_e( 'Downloadable files', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_download_limit" class="wpie_checkbox_label"><?php esc_html_e( 'Download limit', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_download_expiry" class="wpie_checkbox_label"><?php esc_html_e( 'Download expiry', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_tax_status" class="wpie_checkbox_label"><?php esc_html_e( 'Tax Status', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_general_tax_class" class="wpie_checkbox_label"><?php esc_html_e( 'Tax Class', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_inventory" class="wpie_checkbox_label"><strong><?php esc_html_e( 'Product Inventory', 'vj-wp-import-export' ); ?></strong></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_manage_stock" class="wpie_checkbox_label"><?php esc_html_e( 'Manage stock', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_stock" class="wpie_checkbox_label"><?php esc_html_e( 'Stock Qty', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_low_stock_amount" class="wpie_checkbox_label"><?php esc_html_e( 'Low stock threshold', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_stock_status" class="wpie_checkbox_label"><?php esc_html_e( 'Stock status', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_backorders" class="wpie_checkbox_label"><?php esc_html_e( 'Allow Backorders?', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_inventory_sold_individually" class="wpie_checkbox_label"><?php esc_html_e( 'Sold Individually?', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                
                                                        </div>
                                                </div>  
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_shipping" class="wpie_checkbox_label"><?php esc_html_e( 'Product Shipping', 'vj-wp-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_shipping_weight" class="wpie_checkbox_label"><?php esc_html_e( 'Weight', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_shipping_dimensions" class="wpie_checkbox_label"><?php esc_html_e( 'Dimensions', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_shipping_shipping_class" class="wpie_checkbox_label"><?php esc_html_e( 'Shipping Class', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                        </div>
                                                </div>  
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_linked_products" class="wpie_checkbox_label"><?php esc_html_e( 'Product Linked Products', 'vj-wp-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_linked_products_up_sells" class="wpie_checkbox_label"><?php esc_html_e( 'Up Sells', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_linked_products_cross_sells" class="wpie_checkbox_label"><?php esc_html_e( 'Cross Sells', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                                                                                                                                                      
                                                        </div>
                                                </div> 
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_attributes" class="wpie_checkbox_label"><strong><?php esc_html_e( 'Product Attributes', 'vj-wp-import-export' ); ?></strong></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_variations" class="wpie_checkbox_label"><?php esc_html_e( 'Product Variations', 'vj-wp-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_variations_enabled" class="wpie_checkbox_label"><?php esc_html_e( 'Variation Enabled', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_variations_description" class="wpie_checkbox_label"><?php esc_html_e( 'Variation Description', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                        </div>
                                                </div>  
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_product_advanced" class="wpie_checkbox_label"><?php esc_html_e( 'Product Advanced', 'vj-wp-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_advanced_purchase_note" class="wpie_checkbox_label"><?php esc_html_e( 'Purchase Note', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_advanced_featured" class="wpie_checkbox_label"><?php esc_html_e( 'Featured', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="is_update_item_product_advanced_catalog_visibility" class="wpie_checkbox_label"><?php esc_html_e( 'Catalog visibility', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                                                                                               
                                                        </div>
                                                </div>  
                                        <?php } ?>                                     
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_checkbox_container">
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_attachments_all" class="wpie_radio_label"><?php esc_html_e( 'Update all Attachments', 'vj-wp-import-export' ); ?></label>
                                                        </div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                ...
                                                                <label for="wpie_item_update_attachments_append" class="wpie_radio_label"><?php esc_html_e( "Don't touch existing Attachments, append new Attachments", 'vj-wp-import-export' ); ?></label>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                        ...
                                        <?php if ( class_exists( "ACF" ) ) { ?>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_acf" class="wpie_checkbox_label"><?php esc_html_e( 'Advanced Custom Fields', 'vj-wp-import-export' ); ?></label>
                                                </div>
                                        <?php } ?>
                                        <div class="wpie_field_mapping_other_option_wrapper">
