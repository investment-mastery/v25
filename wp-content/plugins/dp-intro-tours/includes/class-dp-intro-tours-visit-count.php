...
class Dp_Intro_Tours_Visit_Count {
	...
	public static function process_visit( $user_id ) {
		$visitedData = self::get_visit_count_core( $user_id );
	...
	private static function get_visit_count_core( $user_id ) {
		$current_url = Dp_Intro_Tours_Helper::get_current_url();
		$current_url = Dp_Intro_Tours_Helper::unify_url( $current_url, true, true, true );
	...
	public static function get_visit_count( $user_id ) {
		return Arr::get( self::get_visit_count_core( $user_id ), 'count', 0 );
	}
