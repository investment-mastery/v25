...
class AdminNotice {
	...
	public static function get_ask_for_rating_text( int $activeWeeks, string $productName, $add_greeting_at_the_end = true ) {
		...
		$text = sprintf( __( "Amazing, you've been using the %1\$s for over %2\$s.<br>A nice rating helps us grow, so we can <strong>serve you better</strong> via our support and develop <strong>new cool features</strong> into this free product.<br>We appreciate Your help. It takes just one minute. Thank You:)<br>", 'dp-intro-tours' ), $plugin_name, $time_in_use_text );
