...
* Added - Disable auto insert widgets setting.
...
* Tweak - Deprecated `LearnDash_Dependency_Check_LD_Elementor`, `LearnDash_Elementor_Shortcodes_TinyMCE`, `LearnDash_Elementor` classes.
