...
function dpit_init_acf_cfg() {
	...
	acf_add_local_field_group(
		[
			...
			'title'                 => __( 'Configuration of Intro Tour', 'dp-intro-tours' ) . ( DP_INTRO_TOURS_IS_PRO ? ' (PRO)' : '' ),
			'fields'                => array_filter(
				[
					[
					...
					dpit_get_acf_design_config( dpit_get_acf_themes() ),
...
function dpit_get_acf_themes() {
	$themes = [ 'default' => 'Default' ];

	$options = Dp_Intro_Tours_Helper::get_themes_select_options();
	foreach ( $options as $key => $value ) {
		$themes[ Str::separed_first_part( $value, ':' ) ] = Str::separed_last_part( $value, ':' );
	}
...
function dpit_get_acf_trigger_config( $idx = 0, $editable_roles = [] ) {
	...
	$res = [
		...
		'label'             => $idx === 0 ? __( 'Trigger', 'dp-intro-tours' ) : __( 'Additional Trigger', 'dp-intro-tours' ),
			...
			[
				...
				( $idx === 0 ) ? [
					...
					'instructions'      => __( 'To run this tour globally on all pages, turn this setting on.', 'dp-intro-tours' )
						...
						. ' <a href="' . DP_INTRO_TOURS_HOOK_TUTORIAL_LINK . '" target="_blank">'
						. __( 'PHP or JS filters.', 'dp-intro-tours' )
						. '</a>',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => [
	...
	return [
		...
		'sub_fields'        => [
			...
			[
				...
				'type'              => 'true_false',
				'instructions'      => 'If on, surrounding of targeted element is underemphasized by blur filter instead of dimming.',
				'required'          => 0,
				'conditional_logic' => 0,
				'wrapper'           => [
					'width' => '',
			...
			[
				...
				'label'             => __( 'Bullets Animation Size', 'dp-intro-tours' ),
				'name'              => 'bullet_anim_size',
				'type'              => 'number',
				'instructions'      => __( 'Adjust bullets animation size: 10 - 90 % from window width', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => [
					[
						[
			...
			[
				...
				'label'             => __( 'Scroll Speed', 'dp-intro-tours' ),
				'name'              => 'scroll_speed',
				'type'              => 'number',
				'instructions'      => ' • &ensp;0: ' . __( 'the slowest', 'dp-intro-tours' ) . DP_INTRO_TOURS_SPACER . ' • 100: ' . __( 'no scrolling (immediately fade into to next step)', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => 0,
				'wrapper'           => [
					'width' => '',
			...
			[
				...
				'type'              => 'number',
				'instructions'      => __( 'Maximal width of intro tooltip in pixels. Default [empty or 0] width is based on width of reference element limited by [window width - 40px]', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => 0,
				'wrapper'           => [
					'width' => '',
...
function dpit_get_acf_design_config( $themes ) {
	...
	return [
		...
		'label'             => __( 'Design adjustments', 'dp-intro-tours' ),
		'name'              => 'intro_design',
		'type'              => 'group',
		...
		'sub_fields'        => [
			...
			[
				...
				'label'             => __( 'Theme override', 'dp-intro-tours' ),
				'name'              => 'theme',
				'type'              => 'select',
				'instructions'      => __( 'Override default theme setup from plugin\'s global settings page for this tour.', 'dp-intro-tours' ) . ' ' . Dp_Intro_Tours_Helper::get_pro_link_html( Dp_Intro_Tours_Helper::build_dp_query_string( [ 'dp_qp_lock' => 'start-theme-demo' ], $query_params_defs ), 'Choose your theme visually' ),
				'required'          => 0,
				'conditional_logic' => 0,
				'wrapper'           => [
					'width' => '',
			...
			[
				...
				'type'              => 'color_picker',
				'instructions'      => __( 'Override default accent color from plugin\'s global settings page for this tour.', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => 0,
				'wrapper'           => [
					'width' => '',
			...
			[
				...
				'label'             => __( 'Tooltip container radius override', 'dp-intro-tours' ),
				'name'              => 'tooltip_radius',
				'type'              => 'number',
				'instructions'      => __( 'Override the radius of intro tooltip [px].', 'dp-intro-tours' ) . '<br>' . __( '-1 => default intro theme value is used', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => '',
				'wrapper'           => [
					'width' => '',
			...
			[
				...
				'label'             => __( 'Button radius override', 'dp-intro-tours' ),
				'name'              => 'button_radius',
				'type'              => 'number',
				'instructions'      => __( 'Override the radius of intro buttons [px].', 'dp-intro-tours' ) . '<br>' . __( '-1 => default intro theme value is used', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => '',
				'wrapper'           => [
					'width' => '',
			...
			[
				...
				'label'             => __( 'Highlight layer radius override', 'dp-intro-tours' ),
				'name'              => 'highlight_radius',
				'type'              => 'number',
				'instructions'      => __( 'Override the radius of highlighting layer [px].', 'dp-intro-tours' ) . '<br>' . __( '-1 => default intro theme value is used', 'dp-intro-tours' ),
				'required'          => 0,
				'conditional_logic' => '',
				'wrapper'           => [
					'width' => '',
