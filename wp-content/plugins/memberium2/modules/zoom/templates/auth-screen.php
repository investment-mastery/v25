><div class="wrap">
    <form method="post">
        <h2><?php echo $m4is_a97xh['page_title'];
 ?></h2>
        <fieldset class="wpat-admin-form" data-screen="<?php echo $m4is_couz;
 ?>">
 ...
 ?></th>
                                        <td>
                                            <label style="valign:top;">
                                                <input id="api_key" name="api_key" value="<?php echo $m4is_s2ge5;
 ...
 ?></th>
                                        <td>
                                            <label style="valign:top;">
                                                <input id="api_secret" name="api_secret" value="<?php echo $m4is__djm5;
 ?>" class="widefat" type="text">
                                            </label>
                                        </td>
                                    </tr>
                        ...
                        <div class="wpat-action-row">
                            <?php wp_nonce_field($m4is_swtx, "_{$m4is_swtx}_name");
 ?>
                            <button class="button button-save button-primary" name="<?php echo $m4is_couz;
 ?>-submit">
