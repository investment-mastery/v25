 ...
 */
 ...
 if ( $data['grid-items'] ) { $course_grid_show_progress = ( !empty($atts['progress_bar']) && (int)$atts['progress_bar'] > 0 );
 foreach ( $data['grid-items'] as $item_data ) { include $data['grid-item-template'];
 } } echo "</div>";
