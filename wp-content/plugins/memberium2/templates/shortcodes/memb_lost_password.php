 ...
 */
 ...
 defined('ABSPATH') || die();
 if (! empty($data->message)) { echo "<div class='lost_password_message'>{$data->message}</div>";
 } if (isset($_POST['memb_form_type']) && $_POST['memb_form_type'] == 'memb_lost_password') { echo '<p class="memb_lost_password_submitted">', _x('Your lost password request has been submitted.  Please check your email.', 'memb_lost_password', 'memberium'), '</p>';
