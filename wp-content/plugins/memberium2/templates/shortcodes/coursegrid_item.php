 ...
 */
 ...
 echo ($url) ? "</a>" : "";
        ...
        echo "<div class=\"memberium-course-grid-content\">";
         ...
         if( !empty($item_data['excerpt']) ){ echo "<div class=\"memberium-course-grid-excerpt\">";
 ...
 echo "</div>";
    ...
    echo "<div class=\"memberium-course-grid-footer\">";
         if( $url ){ echo "<a class=\"memberium-course-grid-button\" href=\"{$url}\">";
 } else{ echo "<div class=\"memberium-course-grid-button\">";
 } echo apply_filters("memberium/lms/course/item/button_text", $item_data['button_text'], $item_data, $atts);
 echo ( $url ) ? "</a>" : '</div>';
         if( $course_grid_show_progress ){ echo "<div class=\"memberium-course-grid-progress\">";
